...
/**
 * Construct a new CurrencySubtractExpression.
 */
SUGAR.expressions.CurrencySubtractExpression = function(params, context) {
	this.context = context;
	this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.CurrencySubtractExpression, SUGAR.expressions.NumericExpression, {
    className: "CurrencySubtractExpression",
	evaluate: function() {
			var params = this.getParameters(),
...
/**
 * Construct a new CurrencyMultiplyExpression.
 */
SUGAR.expressions.CurrencyMultiplyExpression = function(params, context) {
	this.context = context;
	this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.CurrencyMultiplyExpression, SUGAR.expressions.NumericExpression, {
    className: "CurrencyMultiplyExpression",
	evaluate: function() {
			var params = this.getParameters(),
			product = 1;
			for (var i = 0; i < params.length; i++) {
...
/**
 * Construct a new CurrencyDivideExpression.
 */
SUGAR.expressions.CurrencyDivideExpression = function(params, context) {
	this.context = context;
	this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.CurrencyDivideExpression, SUGAR.expressions.NumericExpression, {
    className: "CurrencyDivideExpression",
	evaluate: function() {
			var params = this.getParameters(),
...
/**
 * Construct a new CurrencyAddExpression.
 */
SUGAR.expressions.CurrencyAddExpression = function(params, context) {
	this.context = context;
	this.init(params);
}
SUGAR.util.extend(SUGAR.expressions.CurrencyAddExpression, SUGAR.expressions.NumericExpression, {
    className: "CurrencyAddExpression",
	evaluate: function() {
			var params = this.getParameters(),
			sum = 0;
			for (var i = 0; i < params.length; i++) {
 ...
 */
SUGAR.FunctionMap = {
	'and'	:	SUGAR.expressions.AndExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'not'	:	SUGAR.expressions.NotExpression,	'or'	:	SUGAR.expressions.OrExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'now'	:	SUGAR.expressions.NowExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'add'	:	SUGAR.expressions.AddExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'log'	:	SUGAR.expressions.LogExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'rollupCurrencySum'	:	SUGAR.expressions.CurrencySumRelatedExpression,	'currencySubtract'	:	SUGAR.expressions.CurrencySubtractExpression,	'currencyMultiply'	:	SUGAR.expressions.CurrencyMultiplyExpression,	'currencyDivide'	:	SUGAR.expressions.CurrencyDivideExpression,	'currencyAdd'	:	SUGAR.expressions.CurrencyAddExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
