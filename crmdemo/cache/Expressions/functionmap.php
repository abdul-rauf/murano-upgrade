...
$FUNCTION_MAP = array(
			...
			'currencySubtract' => array(
						'class'	=>	'CurrencySubtractExpression',
						'src'	=>	'include/Expressions/Expression/Numeric/CurrencySubtractExpression.php',
			),
			'currencyMultiply' => array(
						'class'	=>	'CurrencyMultiplyExpression',
						'src'	=>	'include/Expressions/Expression/Numeric/CurrencyMultiplyExpression.php',
			),
			'currencyDivide' => array(
						'class'	=>	'CurrencyDivideExpression',
						'src'	=>	'include/Expressions/Expression/Numeric/CurrencyDivideExpression.php',
			),
			'currencyAdd' => array(
						'class'	=>	'CurrencyAddExpression',
						'src'	=>	'include/Expressions/Expression/Numeric/CurrencyAddExpression.php',
			),
