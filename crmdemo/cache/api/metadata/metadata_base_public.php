...
{{#if value}}
    {{#if value.[0]}}
        {{#each value}}
            <input type="text" name="{{name}}" value="{{email_address}}"{{#if def.len}} maxlength="{{def.len}}"{{/if}} class="inherit-width">
        {{/each}}
    {{else}}
        <input type="text" name="{{name}}" value="{{value}}"{{#if def.len}} maxlength="{{def.len}}"{{/if}} class="inherit-width">
    {{/if}}
{{else}}
    <input type="text" name="{{name}}" value=""{{#if def.len}} maxlength="{{def.len}}"{{/if}} class="inherit-width">
{{/if}}
',
        'list-disabled' => '
<input type="text" name="{{name}}" value="{{value}}"{{#if def.placeholder}} placeholder="{{str def.placeholder this.model.module}}"{{/if}} class="inherit-width" disabled>
...
<div class="control-group teamset">
     {{name}} {{name_2}} {{#if primary}}<label>({{str "LBL_COLLECTION_PRIMARY"}})</label>{{/if}}
</div>
{{/each}}
',
        'edit' => '
{{#each value}}
    <div class="control-group">
        <div class="controls controls-three btn-fit">
            <input type="hidden" name="{{../name}}" class="select2 inherit-width" value="{{name}} {{name_2}}" data-id="{{id}}" data-index="{{@index}}">
...
',
    ...
    '_hash' => '6bf76b86ed0244b0e744b8678ba726b6',
  ),
  'views' => 
  array (
    'login' => 
...
<div class="welcome">
    <div class="thumbnail login">
        <div class="tcenter">
            {{!
                Include a custom OEM logo on the login page
            }}
            <img style=\'vertical-align: middle; 130px; height: 65px; padding-bottom: 10px;\' src=\'custom/themes/default/images/clogo.png\' alt=\'Logo\'>
        </div>
...
<div class="error-message">
    ...
    <h1>{{str title}}</h1>
    {{#each messages}}<p>{{str this}}</p>{{/each}}
    {{#if linkText}}<p><a href="javascript:window.history.back()">{{str linkText}}</a></p>{{/if}}
    {{/with}}    
</div>
<div class="sugar-cube-wrapper">
    {{{subFieldTemplate \'sugar-cube\' \'detail\' cubeOptions}}}
...
',
    ...
    '_hash' => '1601d15230daf8df75a16406557630a4',
  ),
  'layouts' => 
  array (
    'footer' => 
...
<footer>
    <div class="table-row">
        {{!
            Include a custom OEM logo in the application footer
        }}
        <img style=\'vertical-align: middle; height: 45px;\' src=\'custom/themes/default/images/clogo.png\' alt=\'Logo\'> 

        <div class="copyright">
            {{str "LBL_POWERED_BY_SUGARCRM"}}
        </div>
...
<div class="navbar navbar-fixed-top">
	...
	<div style="width: 100%;height: 6px;float: left;background: url(custom/styleguide/assets/img/content_topbar.png);"></div>
</div>
',
      ),
      'meta' => 
...
',
    ...
    '_hash' => 'c59aeb49896329edcf82a27dc41b3531',
  ),
  'labels' => 
  array (
    'en_us' => 'cache/api/metadata/lang_en_us_base_public.json?v=1526904062',
    'bg_BG' => 'cache/api/metadata/lang_bg_BG_base_public.json?v=1526904064',
    'cs_CZ' => 'cache/api/metadata/lang_cs_CZ_base_public.json?v=1526904065',
    'da_DK' => 'cache/api/metadata/lang_da_DK_base_public.json?v=1526904066',
    'de_DE' => 'cache/api/metadata/lang_de_DE_base_public.json?v=1526904068',
    'el_EL' => 'cache/api/metadata/lang_el_EL_base_public.json?v=1526904070',
    'es_ES' => 'cache/api/metadata/lang_es_ES_base_public.json?v=1526904071',
    'fr_FR' => 'cache/api/metadata/lang_fr_FR_base_public.json?v=1526904073',
    'he_IL' => 'cache/api/metadata/lang_he_IL_base_public.json?v=1526904074',
    'hu_HU' => 'cache/api/metadata/lang_hu_HU_base_public.json?v=1526904076',
    'it_it' => 'cache/api/metadata/lang_it_it_base_public.json?v=1526904077',
    'lt_LT' => 'cache/api/metadata/lang_lt_LT_base_public.json?v=1526904079',
    'ja_JP' => 'cache/api/metadata/lang_ja_JP_base_public.json?v=1526904080',
    'ko_KR' => 'cache/api/metadata/lang_ko_KR_base_public.json?v=1526904082',
    'lv_LV' => 'cache/api/metadata/lang_lv_LV_base_public.json?v=1526904083',
    'nb_NO' => 'cache/api/metadata/lang_nb_NO_base_public.json?v=1526904085',
    'nl_NL' => 'cache/api/metadata/lang_nl_NL_base_public.json?v=1526904086',
    'pl_PL' => 'cache/api/metadata/lang_pl_PL_base_public.json?v=1526904088',
    'pt_PT' => 'cache/api/metadata/lang_pt_PT_base_public.json?v=1526904089',
    'ro_RO' => 'cache/api/metadata/lang_ro_RO_base_public.json?v=1526904091',
    'ru_RU' => 'cache/api/metadata/lang_ru_RU_base_public.json?v=1526904092',
    'sv_SE' => 'cache/api/metadata/lang_sv_SE_base_public.json?v=1526904094',
    'tr_TR' => 'cache/api/metadata/lang_tr_TR_base_public.json?v=1526904095',
    'zh_CN' => 'cache/api/metadata/lang_zh_CN_base_public.json?v=1526904097',
    'pt_BR' => 'cache/api/metadata/lang_pt_BR_base_public.json?v=1526904098',
    'ca_ES' => 'cache/api/metadata/lang_ca_ES_base_public.json?v=1526904100',
    'en_UK' => 'cache/api/metadata/lang_en_UK_base_public.json?v=1526904101',
    'sr_RS' => 'cache/api/metadata/lang_sr_RS_base_public.json?v=1526904102',
    'sk_SK' => 'cache/api/metadata/lang_sk_SK_base_public.json?v=1526904103',
    'sq_AL' => 'cache/api/metadata/lang_sq_AL_base_public.json?v=1526904105',
    'et_EE' => 'cache/api/metadata/lang_et_EE_base_public.json?v=1526904106',
    'es_LA' => 'cache/api/metadata/lang_es_LA_base_public.json?v=1526904108',
    'fi_FI' => 'cache/api/metadata/lang_fi_FI_base_public.json?v=1526904109',
    'zh_TW' => 'cache/api/metadata/lang_zh_TW_base_public.json?v=1526904110',
    'ar_SA' => 'cache/api/metadata/lang_ar_SA_base_public.json?v=1526904111',
    'uk_UA' => 'cache/api/metadata/lang_uk_UA_base_public.json?v=1526904112',
    'default' => 'en_us',
  ),
  'ordered_labels' => 
  array (
    'en_us' => 'cache/api/metadata/lang_en_us_base_public_ordered.json?v=1526904062',
    'bg_BG' => 'cache/api/metadata/lang_bg_BG_base_public_ordered.json?v=1526904064',
    'cs_CZ' => 'cache/api/metadata/lang_cs_CZ_base_public_ordered.json?v=1526904065',
    'da_DK' => 'cache/api/metadata/lang_da_DK_base_public_ordered.json?v=1526904066',
    'de_DE' => 'cache/api/metadata/lang_de_DE_base_public_ordered.json?v=1526904068',
    'el_EL' => 'cache/api/metadata/lang_el_EL_base_public_ordered.json?v=1526904070',
    'es_ES' => 'cache/api/metadata/lang_es_ES_base_public_ordered.json?v=1526904071',
    'fr_FR' => 'cache/api/metadata/lang_fr_FR_base_public_ordered.json?v=1526904073',
    'he_IL' => 'cache/api/metadata/lang_he_IL_base_public_ordered.json?v=1526904074',
    'hu_HU' => 'cache/api/metadata/lang_hu_HU_base_public_ordered.json?v=1526904076',
    'it_it' => 'cache/api/metadata/lang_it_it_base_public_ordered.json?v=1526904077',
    'lt_LT' => 'cache/api/metadata/lang_lt_LT_base_public_ordered.json?v=1526904079',
    'ja_JP' => 'cache/api/metadata/lang_ja_JP_base_public_ordered.json?v=1526904080',
    'ko_KR' => 'cache/api/metadata/lang_ko_KR_base_public_ordered.json?v=1526904082',
    'lv_LV' => 'cache/api/metadata/lang_lv_LV_base_public_ordered.json?v=1526904083',
    'nb_NO' => 'cache/api/metadata/lang_nb_NO_base_public_ordered.json?v=1526904085',
    'nl_NL' => 'cache/api/metadata/lang_nl_NL_base_public_ordered.json?v=1526904086',
    'pl_PL' => 'cache/api/metadata/lang_pl_PL_base_public_ordered.json?v=1526904088',
    'pt_PT' => 'cache/api/metadata/lang_pt_PT_base_public_ordered.json?v=1526904089',
    'ro_RO' => 'cache/api/metadata/lang_ro_RO_base_public_ordered.json?v=1526904091',
    'ru_RU' => 'cache/api/metadata/lang_ru_RU_base_public_ordered.json?v=1526904092',
    'sv_SE' => 'cache/api/metadata/lang_sv_SE_base_public_ordered.json?v=1526904094',
    'tr_TR' => 'cache/api/metadata/lang_tr_TR_base_public_ordered.json?v=1526904095',
    'zh_CN' => 'cache/api/metadata/lang_zh_CN_base_public_ordered.json?v=1526904097',
    'pt_BR' => 'cache/api/metadata/lang_pt_BR_base_public_ordered.json?v=1526904098',
    'ca_ES' => 'cache/api/metadata/lang_ca_ES_base_public_ordered.json?v=1526904100',
    'en_UK' => 'cache/api/metadata/lang_en_UK_base_public_ordered.json?v=1526904101',
    'sr_RS' => 'cache/api/metadata/lang_sr_RS_base_public_ordered.json?v=1526904102',
    'sk_SK' => 'cache/api/metadata/lang_sk_SK_base_public_ordered.json?v=1526904103',
    'sq_AL' => 'cache/api/metadata/lang_sq_AL_base_public_ordered.json?v=1526904105',
    'et_EE' => 'cache/api/metadata/lang_et_EE_base_public_ordered.json?v=1526904106',
    'es_LA' => 'cache/api/metadata/lang_es_LA_base_public_ordered.json?v=1526904108',
    'fi_FI' => 'cache/api/metadata/lang_fi_FI_base_public_ordered.json?v=1526904109',
    'zh_TW' => 'cache/api/metadata/lang_zh_TW_base_public_ordered.json?v=1526904110',
    'ar_SA' => 'cache/api/metadata/lang_ar_SA_base_public_ordered.json?v=1526904111',
    'uk_UA' => 'cache/api/metadata/lang_uk_UA_base_public_ordered.json?v=1526904112',
    'default' => 'en_us',
  ),
  'config' => 
  array (
  ...
  'jssource' => 'cache/javascript/base/components_c5dc9083053ee2679934f739aba9acbb.js',
  'logo_url' => 'custom/themes/default/images/company_logo.png?v=avbyNukrlkB5_p5AOP6Xkw',
  '_override_values' => 
  array (
    1 => 'fields',
    6 => 'config',
  ),
  '_hash' => '1c8f2a6f99ad7a77b098d5931c1b0f47',
);