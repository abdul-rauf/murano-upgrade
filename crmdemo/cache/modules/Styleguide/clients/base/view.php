...
<section id="examples">
  ...
  <div class="row-fluid">
    ...
    <div class="span5">
      <p>
        <a class="btn"><i class="icon-repeat"></i> Reload</a>
        <a class="btn btn-success"><i class="icon-shopping-cart icon-large"></i> Checkout</a>
        <a class="btn btn-danger"><i class="icon-trash icon-large"></i> Delete</a>
      </p>
      <p>
        <a class="btn btn-large btn-primary"><i class="icon-comment"></i> Comment</a>
        <a class="btn btn-small"><i class="icon-cog"></i> Settings</a>
        <a class="btn btn-small btn-info"><i class="icon-info-sign"></i> Info</a>
      </p>
      <div class="well" style="padding: 8px 0;">
        <ul class="nav nav-list">
          <li class="active"><a><i class="icon-home"></i> Home</a></li>
          <li><a><i class="icon-book"></i> Library</a></li>
          <li><a><i class="icon-pencil"></i> Applications</a></li>
          <li><a><i class="icon-cogs"></i> Settings</a></li>
        </ul>
      </div>
    </div>
    <div class="span4">
      <div class="btn-toolbar">
        ...
        <div class="btn-group">
          <a class="btn btn-primary"><i class="icon-user"></i> User</a>
          <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><i class="icon-caret-down"></i></a>
  ...
  <div class="row-fluid">
    ...
    <div class="span4">
      <p>
        <a class="btn btn-large btn-danger"><i class="icon-flag icon-2x pull-left"></i>Font Awesome<br>Version 3.0</a>
      </p>
      <a class="btn btn-primary"><i class="icon-refresh icon-spin"></i> Synchronizing Content...</a>
    </div>
  </div>
  <div class="row-fluid">
    <div class="span12">
  ...
  <div class="row-fluid">
    ...
    <div class="span3" style="padding:40px 0">
        <span class="sugar-cube sc-small icon-spin"></span>
    </div>
  </div>
      ...
      <table class="table table-bordered table-striped">
        <tbody>
          ...
          <tr>
            ...
            <td><span class="swatch swatch-bordered grayLighter"></span></td>
          </tr>
          <tr>
      ...
      <table class="table table-bordered table-striped">
        <tbody>
          ...
          <tr>
            ...
            <td><span class="swatch warningBorder"></span></td>
          </tr>
          ...
          <tr>
            ...
            <td class="hex mono">#fff</td>
            <td><span class="swatch errorTextAlert swatch-bordered"></span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span class="swatch errorBorder"></span></td>
          </tr>
          ...
          <tr>
            ...
            <td class="mono"><code>@white</code></td>
            <td class="hex mono">#fff</td>
            <td><span class="swatch successText swatch-bordered"></span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span class="swatch successBorder"></span></td>
          </tr>
          ...
          <tr>
            ...
            <td class="mono"><code>@white</code></td>
            <td class="hex mono">#fff</td>
            <td><span class="swatch infoText swatch-bordered"></span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><span class="swatch infoBorder"></span></td>
          </tr>
        </tbody>
      </table>
    </div>
...
&lt;/div&gt;
      ...
      <p>To make handling of alerts easier in Sugar7, there is now a utility function called <code>app.alert</code>. This function is based on Bootstrap\'s <code>bootstrap-alert.js</code> plugin. Although you should never need to access the Boostrap plugin directly, its documentation can be found here <a href=""><i class="icon-book"></i> boostrap-alert.js</a>.</p>
      ...
      <div id="navbar-example" class="navbar navbar-static">
        <div class="navbar-inner">
          <div class="container" style="width: auto;">
            ...
            <ul class="nav">
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown">Dropdown <i class="icon-caret-down"></i></a>
                <ul class="dropdown-menu">
                  <li><a>Action</a></li>
              ...
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown">Dropdown 2 <i class="icon-caret-down"></i></a>
                <ul class="dropdown-menu">
                  <li><a>Action</a></li>
                  <li><a>Another action</a></li>
                  <li><a>Something else here</a></li>
            ...
            <ul class="nav pull-right">
              <li id="fat-menu" class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown">Dropdown 3 <i class="icon-caret-down"></i></a>
                <ul class="dropdown-menu">
                  <li><a>Action</a></li>
                  <li><a>Another action</a></li>
                  <li><a>Something else here</a></li>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td><button class="btn btn-secondary dashlet-example" data-dashlet="dashlet-chart"><i class="icon-eye-open"></i></button></td>
                </tr>
                <tr>
                    <td>Summary</td>
                    <td>The forecast dashlet brings together several key bits of data and uses separators and labels for visualization.</td>
                    <td><button class="btn btn-secondary dashlet-example" data-dashlet="forecastdetails"><i class="icon-eye-open"></i></button></td>
                </tr>
                <tr>
                    <td>Tabbed</td>
    ...
    &lt;div class="dashlet-tabs-row:&gt;
        &lt;div class="dashlet-tab [active]"&gt;
            &lt;a data-toggle="tab" data-action="tab-switcher"&gt;
                    ...
                    <td><button class="btn btn-secondary dashlet-example" data-dashlet="dashlet-tabbed"><i class="icon-eye-open"></i></button></td>
                </tr>
                <tr>
                    <td>Article</td>
                    ...
                    <td><button class="btn btn-secondary dashlet-example" data-dashlet="top-activity-user" data-module="Home"><i class="icon-eye-open"></i></button></td>
                </tr>
                <tr>
                    <td>Item</td>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td><button class="btn btn-secondary dashlet-example" data-dashlet="active-tasks"><i class="icon-eye-open"></i></button></td>
                </tr>
                <tr>
                    <td>Avatar</td>
...
<div id="dashboards_homepage_2" class="modal hide fade" style="width:90%;margin-left:-45%;">
    <div class="modal-header">
        <a class="close btn btn-invisible" data-dismiss="modal"><i class="icon-remove"></i></a>
...
&lt;button type="button" class="btn btn-large" disabled&gt;Button&lt;/button&gt;
  ...
  <p class="bs-docs-example">
    <a class="btn"><i class="icon-favorite"></i></a>
    <a class="btn btn-invisible"><i class="icon-favorite"></i></a>
  </p>
<pre class="prettyprint linenums">
    &lt;a class="btn"&gt;&lt;i class="icon-favorite"&gt;&lt;/i&gt;&lt;/a&gt;
    &lt;a class="btn btn-invisible"&gt;&lt;i class="icon-favorite"&gt;&lt;/i&gt;&lt;/a&gt;
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody>
      <tr>
        <td>Normal</td>
        <td><code>.btn</code></td>
        <td><a class="btn">Button</a><a class="btn"><i class="icon-ambulance"></i></a></td>
        <td><a class="btn disabled">Button</a><a class="btn disabled"><i class="icon-ambulance"></i></a></td>
        <td><a class="btn active">Button</a><a class="btn active"><i class="icon-ambulance"></i></a></td>
      </tr>
      <tr>
        <td>Invisible</td>
        <td><code>.btn .btn-invisible</code></td>
        <td><a class="btn btn-invisible">Button</a><a class="btn btn-invisible"><i class="icon-ambulance"></i></a></td>
        <td><a class="btn btn-invisible disabled">Button</a><a class="btn btn-invisible disabled"><i class="icon-ambulance"></i></a></td>
        <td><a class="btn btn-invisible active">Button</a><a class="btn btn-invisible active"><i class="icon-ambulance"></i></a></td>
      </tr>
      <tr>
        <td>Link</td>
        <td><code>.btn .btn-invisible .btn-link</code></td>
        <td><a class="btn btn-invisible btn-link">Button</a><a class="btn btn-invisible btn-link"><i class="icon-ambulance"></i></a></td>
        <td><a class="btn btn-invisible btn-link disabled">Button</a><a class="btn btn-invisible btn-link disabled"><i class="icon-ambulance"></i></a></td>
        <td><a class="btn btn-invisible btn-link active">Button</a><a class="btn btn-invisible btn-link active"><i class="icon-ambulance"></i></a></td>
      </tr>
    </tbody>
  </table>
</section>
...
<section id="button-dropdowns">
  ...
  <div class="row-fluid">
    <div class="span4">
      ...
      <div class="btn-toolbar" style="margin-top: 18px;">
        <div class="btn-group">
          <a class="btn dropdown-toggle" data-toggle="dropdown">Action <i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
        ...
        <div class="btn-group">
          <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Action <i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
        ...
        <div class="btn-group">
          <a class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Danger <i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
      ...
      <div class="btn-toolbar">
        <div class="btn-group">
          <a class="btn btn-success dropdown-toggle" data-toggle="dropdown">Success <i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
        ...
        <div class="btn-group">
          <a class="btn btn-info dropdown-toggle" data-toggle="dropdown">Info <i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
    ...
    <div class="span4">
      ...
      <div class="btn-toolbar" style="margin-top: 18px;">
        <div class="btn-group">
          ...
          <a class="btn dropdown-toggle" data-toggle="dropdown"><i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
        ...
        <div class="btn-group">
          ...
          <a class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
      ...
      <div class="btn-toolbar">
        <div class="btn-group">
          ...
          <a class="btn btn-success dropdown-toggle" data-toggle="dropdown"><i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
        ...
        <div class="btn-group">
          ...
          <a class="btn btn-info dropdown-toggle" data-toggle="dropdown"><i class="icon-caret-down"></i></a>
          <ul class="dropdown-menu">
            <li><a>Action</a></li>
            <li><a>Another action</a></li>
            <li><a>Something else here</a></li>
...
&lt;/ul&gt;
    ...
    <div class="span4">
      ...
      <div class="well" style="padding: 8px 0;">
        <ul class="nav nav-list">
          <li class="nav-header">List header</li>
          <li class="active"><a><i class="icon-white icon-home"></i> Home</a></li>
          <li><a><i class="icon-book"></i> Library</a></li>
          <li><a><i class="icon-pencil"></i> Applications</a></li>
          <li class="nav-header">Another list header</li>
          <li><a><i class="icon-user"></i> Profile</a></li>
          <li><a><i class="icon-cog"></i> Settings</a></li>
          <li><a><i class="icon-flag"></i> Help</a></li>
        </ul>
      </div> <!-- /well -->
<pre class="prettyprint linenums">
&lt;ul class="nav nav-list"&gt;
        ...
        {{/if}}
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span4">
                                <div class="record">
                                    <div class="row-fluid">
                                        <div class="span12 record-cell" data-type="{{this.type}}" id="{{this.type}}_detail_record">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section>
    <ul class="sg-main listed">
        ...
        <li><i class="icon-reorder icon-3x"></i><a href="#Styleguide/view/list">Default List View</a></li>
...
({className:\'container-fluid\',_render:function(){var self=this;this._super(\'_render\');}})',
  ...
  '_hash' => '65123ed8e78a070faf9162ca995547e7',
);
