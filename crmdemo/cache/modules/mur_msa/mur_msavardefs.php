<?php 
 $GLOBALS["dictionary"]["mur_msa"]=array (
  'table' => 'mur_msa',
  'audited' => true,
  ...
  array (
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'mur_msa_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mur_msa_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mur_msa_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'mur_msa_activities',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mur_msa_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mur_msa_assigned_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mur_msa_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'mur_msa_email_addresses',
      'source' => 'non-db',
