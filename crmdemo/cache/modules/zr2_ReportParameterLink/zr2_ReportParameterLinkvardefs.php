 ...
 $GLOBALS["dictionary"]["zr2_ReportParameterLink"]=array (
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'zr2_reportparameterlink_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'zr2_reportparameterlink_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'zr2_reportparameterlink_activities',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_zr_reportparameterlink_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_zr2_reportparameterlink_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_zr2_reportparameterlink_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_zr2_reportparameterlink_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
