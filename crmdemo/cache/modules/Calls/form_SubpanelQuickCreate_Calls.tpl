...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Calls","field_to_name_array":{"id":"assigned_user_id","full_name":"assigned_user_name"}}{/literal}, 
"single", 
true
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TEAMS' module='Calls'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{sugarvar_teamset parentFieldArray=fields vardef=$fields.team_name tabindex='0' display='' labelSpan='' fieldSpan='' formName='form_SubpanelQuickCreate_Calls' tabindex=1 displayType='renderEditView'  	 }
{else}
{counter name="panelFieldCount"}

{sugarvar_teamset parentFieldArray=fields vardef=$fields.team_name tabindex='0' display='' labelSpan='' fieldSpan='' formName='form_SubpanelQuickCreate_Calls' tabindex=1 displayType='renderDetailView'  	 }
{/if}
{else}
<td></td><td></td>
{/if}
...
*}{literal}
<script type="text/javascript">
addForm('form_SubpanelQuickCreate_Calls');addToValidate('form_SubpanelQuickCreate_Calls', 'my_favorite', 'bool', false,'{/literal}{sugar_translate label='LBL_FAVORITE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'following', 'bool', false,'{/literal}{sugar_translate label='LBL_FOLLOWING' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_SUBJECT' module='Calls' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Calls', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='Calls' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Calls', 'doc_owner', 'id', false,'{/literal}{sugar_translate label='LBL_DOC_OWNER' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'user_favorites', 'id', false,'{/literal}{sugar_translate label='LBL_USER_FAVORITES' module='Calls' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Calls', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'team_id', 'team_list', false,'{/literal}{sugar_translate label='LBL_TEAM_ID' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'team_set_id', 'id', false,'{/literal}{sugar_translate label='LBL_TEAM_SET_ID' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'team_count', 'relate', true,'{/literal}{sugar_translate label='LBL_TEAMS' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'team_name', 'teamset', true,'{/literal}{sugar_translate label='LBL_TEAMS' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'duration_hours', 'int', false,'{/literal}{sugar_translate label='LBL_DURATION_HOURS' module='Calls' for_js=true}{literal}' );
...
addToValidateDateBefore('form_SubpanelQuickCreate_Calls', 'date_start', 'datetimecombo', false,'{/literal}{sugar_translate label='LBL_DATE' module='Calls' for_js=true}{literal}', 'date_end' );
...
addToValidate('form_SubpanelQuickCreate_Calls', 'accept_status_users', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCEPT_STATUS' module='Calls' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Calls', 'send_invites', 'bool', false,'{/literal}{sugar_translate label='LBL_SEND_INVITES' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'calling_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CALLING' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'called_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CALLED' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'extension_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_EXTENSION' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'ring_c', 'int', false,'{/literal}{sugar_translate label='LBL_RING' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'wait_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_WAIT' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'answer_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ANSWER' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'site_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SITE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'cost_c', 'currency', false,'{/literal}{sugar_translate label='LBL_COST' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'charge_description_c', 'text', false,'{/literal}{sugar_translate label='LBL_CHARGE_DESCRIPTION' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'call_source_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CALL_SOURCE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'talk_c', 'int', false,'{/literal}{sugar_translate label='LBL_TALK' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'call_hour_c', 'int', false,'{/literal}{sugar_translate label='LBL_CALL_HOUR' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'users_calls_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_USERS_CALLS_1_FROM_USERS_TITLE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'users_calls_1users_ida', 'id', false,'{/literal}{sugar_translate label='LBL_USERS_CALLS_1_FROM_CALLS_TITLE_ID' module='Calls' for_js=true}{literal}' );
...
YAHOO.util.Event.onContentReady('form_SubpanelQuickCreate_Calls', SUGAR.forms.AssignmentHandler.loadComplete);});</script>{/literal}
