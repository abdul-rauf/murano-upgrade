 ...
 $GLOBALS["dictionary"]["zr2_Report"]=array (
  ...
  array (
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'zr2_report_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
    ),
    'following' => 
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'zr2_report_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
    ),
    'id' => 
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'zr2_report_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'zr2_report_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'zr2_report_activities',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'zr2_report_assigned_user',
    ...
    'zr2_reportcontainer_zr2_report_name' => 
    array (
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_zr2_report_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_zr2_report_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
