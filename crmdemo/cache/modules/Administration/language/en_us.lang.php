...
',
  ...
  'LBL_FORECAST_DESC' => 'Configure admin setting for the Forecasts module. The Forecasts Setting will include Time Period, Forecasts Ranges, Worksheet Columns, and Scenarios.',
  ...
  'LBL_PASSWORD_SYST_GENERATED_PWD_HELP' => 'When this feature is enabled, users will receive a randomly generated password via email. Requirements for this feature are: 1) a outbound email server must be configured properly in Email Settings, and 2) users must have valid email addresses in their user records',
  ...
  'LBL_SUPPORT_TITLE' => 'SugarCRM Support',
...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_CONVERT_DISC_CLIENT_SERVER_URL_EMPTY_ERROR' => 'Server URL cannot be empty.',
  'LBL_CONVERT_DISC_CLIENT_USER_NAME_EMPTY_ERROR' => 'User Name cannot be empty.',
  'LBL_CONVERT_DISC_CLIENT_PASSWORD_EMPTY_ERROR' => 'Password cannot be empty.',
  'LBL_CONVERT_DISC_CLIENT_ADMIN_NAME_EMPTY' => 'Admin Name cannot be empty.',
  'LBL_CONVERT_DISC_CLIENT_CONFIG_WRITABLE_ERROR' => 'Please make your config.php writable in order to continue.',
  'LBL_CONVERT_DISC_CLIENT_SERVER_URL_REQUIRED' => 'Server URL is required',
  'LBL_CONVERT_DISC_CLIENT_SERVER_CLIENT_IP_ERROR' => 'Server and Client must be on separate machines with unique ip addresses',
  'LBL_CONVERT_DISC_CLIENT_NO_LICENSE' => 'No licenses available for offline client',
  'LBL_CONVERT_DISC_CLIENT_LOGIN_FAILED_ERROR' => 'Login failed with error: ',
  'LBL_CONVERT_DISC_CLIENT_SWITCH_TO_USER_ERROR' => 'Switch to {0} failed with error: ',
  ...
  'LBL_CONVERT_DISC_CLIENT_CONFIG_WRITABLE_AGAIN_ERROR' => 'Failed to write your config.php file, please make it writable and try again (it was writable before the submit).',
  'LBL_CONVERT_DISC_CLIENT_DONE_LOGOUT' => 'Done - will auto logout in <div id="seconds_left">10</div> seconds',
  ...
  'LBL_MANAGE_ZUCKERREPORTS2CONFIG' => 'ZuckerReports Configuration',
  'LBL_ZUCKERREPORTS2CONFIG' => 'Set the ZuckerReports configuration parameters',
  'LBL_ZUCKERREPORTS2CONFIG_DESC' => 'Manage your ZuckerReports settings.',
  'LBL_ZUCKERREPORTS2CONFIG_TITLE' => 'ZuckerReports',
  'LBL_UC2C_TITLE' => 'Universal Click to Call Settings',
  'LBL_UC2C_DESC' => 'Manage the Click to Call Settings',
  'LBL_UC2C_PANEL_NAME' => 'Universal Click to Call Adminstration',
  'LBL_UC2C_PANEL_DESC' => 'Setup the Click to Call Integration: Enter the License Key',
  'LBL_UC2C_ADMIN_TITLE' => 'Universal Click to Call Administration And Settings',
  'LBL_UC2C_UPDATE_MSG' => 'Click to Call Setting Have Been Updated....',
);