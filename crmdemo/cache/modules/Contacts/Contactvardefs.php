 ...
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      ...
      'source' => 'non-db',
      'vname' => 'LBL_CL_CLIENT_LIST_CONTACTS_FROM_CL_CLIENT_LIST_TITLE',
    ),
    'contactsmap_c' => 
    array (
      'required' => false,
      ...
      'type' => 'iframe',
      'massupdate' => false,
      'default' => 'https://www.google.com/maps/embed/v1/place?key=API_KEY&q= {primary_address_street}, {primary_address_city}, {primary_address_postalcode}, {primary_address_country}',
      'no_default' => false,
      'comments' => '',
      'help' => '',
      'importable' => 'false',
