<?php /* Smarty version 2.6.11, created on 2018-06-05 08:51:50
         compiled from custom/modules/Leads/ListViewPagination.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_action_menu', 'custom/modules/Leads/ListViewPagination.tpl', 53, false),array('function', 'sugar_getimage', 'custom/modules/Leads/ListViewPagination.tpl', 68, false),)), $this); ?>
<?php echo '
<script>
function send_page(page_num){
...
<span class='ab'></span></div><?php endif; ?>
					...
					<input type='text' id='page_number' name='page_number' title='type page no here' class='input' onBlur='sListView.save_checks(20 * this.value, "<?php echo $this->_tpl_vars['moduleString']; ?>
")'' >
