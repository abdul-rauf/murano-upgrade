<?php /* Smarty version 2.6.11, created on 2018-05-21 12:03:32
         compiled from include/SugarFields/Fields/Link/ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_fetch', 'include/SugarFields/Fields/Link/ListView.tpl', 13, false),array('function', 'sugar_replace_vars', 'include/SugarFields/Fields/Link/ListView.tpl', 16, false),array('modifier', 'to_url', 'include/SugarFields/Fields/Link/ListView.tpl', 19, false),)), $this); ?>
<?php ob_start();  echo smarty_function_sugar_fetch(array('object' => $this->_tpl_vars['parentFieldArray'],'key' => $this->_tpl_vars['col']), $this); $this->_smarty_vars['capture']['getLink'] = ob_get_contents();  $this->assign('link', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['vardef']['gen'] && $this->_tpl_vars['vardef']['default']): ?>
