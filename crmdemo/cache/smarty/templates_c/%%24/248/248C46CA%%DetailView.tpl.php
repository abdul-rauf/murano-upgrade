...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/DetailView/DetailView.tpl', 22, false),array('function', 'sugar_evalcolumn', 'include/DetailView/DetailView.tpl', 142, false),array('function', 'sugar_field', 'include/DetailView/DetailView.tpl', 147, false),array('modifier', 'upper', 'include/DetailView/DetailView.tpl', 25, false),array('modifier', 'count', 'include/DetailView/DetailView.tpl', 91, false),)), $this); ?>
{*
/*
...
SUGAR.util.doWhen("typeof collapsePanel == 'function'",
        function(){ldelim}
            ...
            if(sugar_panel_collase != null) {ldelim}
                ...
                for(panel in sugar_panel_collase['<?php echo $this->_tpl_vars['module']; ?>
_d'])
                    if(sugar_panel_collase['<?php echo $this->_tpl_vars['module']; ?>
_d'][panel])
                        collapsePanel(panel);
                    else
                        expandPanel(panel);
