<?php /* Smarty version 2.6.11, created on 2018-06-05 08:51:50
         compiled from custom/modules/Leads/ListViewGeneric.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'custom/modules/Leads/ListViewGeneric.tpl', 35, false),array('function', 'counter', 'custom/modules/Leads/ListViewGeneric.tpl', 127, false),array('function', 'sugar_translate', 'custom/modules/Leads/ListViewGeneric.tpl', 141, false),array('function', 'sugar_getimage', 'custom/modules/Leads/ListViewGeneric.tpl', 147, false),array('function', 'sugar_ajax_url', 'custom/modules/Leads/ListViewGeneric.tpl', 227, false),array('function', 'sugar_evalcolumn_old', 'custom/modules/Leads/ListViewGeneric.tpl', 230, false),array('function', 'sugar_field', 'custom/modules/Leads/ListViewGeneric.tpl', 232, false),array('modifier', 'replace', 'custom/modules/Leads/ListViewGeneric.tpl', 72, false),array('modifier', 'default', 'custom/modules/Leads/ListViewGeneric.tpl', 130, false),array('modifier', 'lower', 'custom/modules/Leads/ListViewGeneric.tpl', 133, false),array('modifier', 'upper', 'custom/modules/Leads/ListViewGeneric.tpl', 136, false),)), $this); ?>
...
'></script>
<script type='text/javascript' src='custom/modules/Leads/worked.js'></script>

<link type="text/css" rel="stylesheet" href='custom/modules/Leads/style_worked.css'></link>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'custom/modules/Leads/ListViewPagination.tpl', 'smarty_include_vars' => array()));
...
'>
				...
				<?php endif; ?>
				<?php if ($this->_tpl_vars['favorites']): ?>
					<td><?php echo $this->_tpl_vars['rowData']['star']; ?>
</td>
				<?php endif; ?>
							<td>
			<?php if ($this->_tpl_vars['rowData']['DATA_UPDATED']): ?>
	<div class="worked" title="worked"><div  class="on"   onclick="addToWorked(this, 'Leads',  '<?php echo $this->_tpl_vars['rowData']['ID']; ?>
')">W</div></div>
	<?php else: ?>
	<div class="worked" title="not worked"><div  class="off"  onclick="addToWorked(this, 'Leads',  '<?php echo $this->_tpl_vars['rowData']['ID']; ?>
')">W</div></div>
<?php endif; ?>
			</td>
				<?php if (! empty ( $this->_tpl_vars['quickViewLinks'] )): ?>
...
"
	data-record='<?php echo $this->_tpl_vars['rowData']['ID']; ?>
' data-module='<?php if ($this->_tpl_vars['params']['dynamic_module']):  echo $this->_tpl_vars['rowData'][$this->_tpl_vars['params']['dynamic_module']];  else:  echo $this->_tpl_vars['pageData']['bean']['moduleDir'];  endif; ?>'
