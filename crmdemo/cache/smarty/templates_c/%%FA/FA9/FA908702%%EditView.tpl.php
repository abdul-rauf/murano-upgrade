<?php /* Smarty version 2.6.11, created on 2018-06-05 09:00:37
         compiled from include/EditView/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/EditView/EditView.tpl', 25, false),array('function', 'math', 'include/EditView/EditView.tpl', 99, false),array('function', 'sugar_field', 'include/EditView/EditView.tpl', 194, false),array('function', 'sugar_evalcolumn', 'include/EditView/EditView.tpl', 199, false),array('modifier', 'upper', 'include/EditView/EditView.tpl', 29, false),array('modifier', 'count', 'include/EditView/EditView.tpl', 101, false),)), $this); ?>
{*
/*
...
.acl > 1 || ($showDetailData && $fields.<?php echo $this->_tpl_vars['colData']['field']['name']; ?>
.acl > 0)}
	<?php endif; ?>
...
&nbsp;
			...
			<?php endif; ?>
		<?php if (! empty ( $this->_tpl_vars['colData']['field']['name'] )): ?>
		<?php if ($this->_tpl_vars['showDetailData']): ?>
		{else}
			<?php if ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']] && ! empty ( $this->_tpl_vars['colData']['field']['fields'] )): ?>
			    <?php $_from = $this->_tpl_vars['colData']['field']['fields']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['subField']):
?>
			        <?php if ($this->_tpl_vars['fields'][$this->_tpl_vars['subField']['name']]): ?>
			            ...
			            <?php echo smarty_function_sugar_field(array('parentFieldArray' => 'fields','tabindex' => $this->_tpl_vars['tabindex'],'vardef' => $this->_tpl_vars['fields'][$this->_tpl_vars['subField']['name']],'displayType' => 'DetailView','displayParams' => $this->_tpl_vars['subField']['displayParams'],'formName' => $this->_tpl_vars['form_name']), $this);?>
&nbsp;
			        <?php endif; ?>
			    <?php endforeach; endif; unset($_from); ?>
			<?php elseif (! empty ( $this->_tpl_vars['colData']['field']['customCode'] )): ?>
                <?php if (! empty ( $this->_tpl_vars['colData']['field']['customCodeReadOnly'] )): ?>
                   <?php echo $this->_tpl_vars['colData']['field']['customCodeReadOnly']; ?>
			...
			<?php elseif ($this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']]): ?>
			    ...
			    {counter name="panelFieldCount"}
				<?php echo smarty_function_sugar_field(array('parentFieldArray' => 'fields','tabindex' => $this->_tpl_vars['tabindex'],'vardef' => $this->_tpl_vars['fields'][$this->_tpl_vars['colData']['field']['name']],'displayType' => 'DetailView','displayParams' => $this->_tpl_vars['colData']['field']['displayParams'],'typeOverride' => $this->_tpl_vars['colData']['field']['type'],'formName' => $this->_tpl_vars['form_name']), $this);?>

			<?php endif; ?>
	    <?php echo $this->_tpl_vars['colData']['field']['suffix']; ?>

		<?php if (! empty ( $this->_tpl_vars['colData']['field']['customCode'] )): ?></td><?php endif; ?>
		<?php endif; ?>
