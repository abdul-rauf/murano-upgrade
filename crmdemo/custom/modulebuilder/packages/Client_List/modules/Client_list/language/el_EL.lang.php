...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Client list Λίστα',
  'LBL_MODULE_NAME' => 'Client list',
  'LBL_MODULE_TITLE' => 'Client list',
  'LBL_MODULE_NAME_SINGULAR' => 'Client list',
  'LBL_HOMEPAGE_TITLE' => 'Δική Μου Client list',
  'LNK_NEW_RECORD' => 'Δημιουργία Client list',
  'LNK_LIST' => 'Προβολή Client list',
  'LNK_IMPORT_CL_CLIENT_LIST' => 'Import Client list',
  'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση Client list',
  ...
  'LBL_NEW_FORM_TITLE' => 'Νέα Client list',
