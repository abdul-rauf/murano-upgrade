...
class LeadsViewEdit extends ViewEdit{
 ...
 function PreDisplay(){
	...
	// $this->getConsultantsWidgetEditView();
	$this->bean->lead_source_description_cp = $this->bean->lead_source_description;
	$this->bean->lead_source_cp = $this->bean->lead_source;
	 parent::PreDisplay();
	
	 $this->bean->load_relationships('mr_consultant_leads');
	$res =$this->bean->mr_consultant_leads->get();
	$cons ="'".implode("','",$res)."'";
	$res_options =array(0=>'');
