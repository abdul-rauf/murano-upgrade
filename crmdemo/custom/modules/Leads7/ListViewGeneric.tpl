...
{if $hideTable == false}
	...
	{include file='custom/modules/Leads/ListViewPagination.tpl'}
	<tr height='20'>
			{if $prerow}
		...
		{foreach name=rowIteration from=$data key=id item=rowData}
			...
			<tr height='20' class='{$_rowColor}S1'>
				...
				{/if}
							<td>
			{if $rowData.DATA_UPDATED}
	<div class="worked" title="worked"><div  class="on"   onclick="addToWorked(this, 'Leads',  '{$rowData.ID}')">W</div></div>
	{else}
	<div class="worked" title="not worked"><div  class="off"  onclick="addToWorked(this, 'Leads',  '{$rowData.ID}')">W</div></div>
{/if}
			</td>
				{if !empty($quickViewLinks)}
