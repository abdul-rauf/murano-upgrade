...
<form name="Quick_email" method="POST" action="index.php?action=group_task&module=Leads">
<input type="hidden" name="from" id="from" value="{$id}">
<input type="hidden" name="action" id="action" value="group_task">
<input type="hidden" name="module" id="module" value="{$module}">
<input type="hidden" name="object" id="object" value="{$object}">
<input type="hidden" name="lead_ids" id="object" value="{$lead_ids}">
