...
$dictionary['cl_Client_list']['fields']['name']['full_text_search']['enabled'] = true;
$dictionary['cl_Client_list']['fields']['name']['full_text_search']['searchable'] = true;
$dictionary['cl_Client_list']['fields']['name']['full_text_search']['boost'] = 1.55;
