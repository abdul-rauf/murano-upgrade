...
$dictionary['rt_sorting']['fields']['date_modified']['full_text_search']['enabled'] = true;
$dictionary['rt_sorting']['fields']['date_modified']['full_text_search']['searchable'] = true;
$dictionary['rt_sorting']['fields']['date_modified']['full_text_search']['aggregations']['date_modified']['type'] = 'DateRange';
$dictionary['rt_sorting']['fields']['date_modified']['full_text_search']['boost'] = 1;
