...
$dictionary['Lead']['fields']['title']['full_text_search']['enabled'] = true;
$dictionary['Lead']['fields']['title']['full_text_search']['searchable'] = false;
$dictionary['Lead']['fields']['title']['full_text_search']['boost'] = 1;
