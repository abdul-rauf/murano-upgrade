...
$dictionary['Lead']['fields']['inv_groups']['full_text_search']['enabled'] = true;
$dictionary['Lead']['fields']['inv_groups']['full_text_search']['searchable'] = false;
$dictionary['Lead']['fields']['inv_groups']['full_text_search']['boost'] = 1;
