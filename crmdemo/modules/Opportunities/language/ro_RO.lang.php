...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulul {{plural_module_name}} vă permite să monitorizați vânzările individuale de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc. Un {{module_name}} va evolua, în mod tipic, prin mai multe Etape de vânzări până când este marcat „Câștigat închis” sau „Câștigat pierdut”. {{plural_module_name}} poate fi valorificat și mai mult folosind modulul {{forecasts_singular_module}}ing Sugar, pentru a înțelege și a previziona tendințele vânzărilor, precum și pentru a concentra lucrul pentru a obține cote de vânzări.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modulul {{plural_module_name}} vă permite să monitorizați vânzările individuale și elementele de linie aferente vânzărilor respective de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date legate de alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.

- Editați câmpurile acestei înregistrări făcând clic pe un câmp individual sau pe butonul Editare.
- Vizualizați sau modificați linkurile pentru alte înregistrări din subpanouri, comutând panoul din stânga jos la „Vizualizare date”.
- Creați și vizualizați comentarii de utilizator și istoricul de modificări ale înregistrărilor în {{activitystream_singular_module}}, comutând panoul din stânga jos la „Flux de activități”.
- Urmăriți sau setați ca preferată această înregistrare folosind pictogramele din dreapta numelui înregistrării.
- Sunt disponibile acțiuni suplimentare în meniul vertical Acțiuni din dreapta butonului Editare.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulul {{plural_module_name}} vă permite să urmăriți vânzările individuale și elementele de linie aferente vânzărilor respective de la început până la sfârșit. Fiecare înregistrare {{module_name}} reprezintă o vânzare potențială și include date de vânzare relevante, precum și date referitoare la alte înregistrări importante, cum ar fi {{quotes_module}}, {{contacts_module}} etc.
...
1. Furnizaţi valorile pentru câmpuri, după cum doriţi.
 ...
 - Faceți clic pe „Afișare mai multe” pentru a expune câmpurile suplimentare, dacă este necesar.
