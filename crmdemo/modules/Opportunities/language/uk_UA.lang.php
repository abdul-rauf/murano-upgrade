...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. Модуль {{module_name}} зазвичай проходить кілька стадій продажу, доки не отримає статус "Виграна" або "Втрачена". Користь від застосування модуля {{plural_module_name}} можна збільшити, використовуючи модуль {{forecasts_singular_module}} системи Sugar для розуміння та прогнозування тенденцій продажів, а також для зосередження роботи на досягненні встановлених квот збуту.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що відносяться до них, від початку до кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.

- Щоб відредагувати поле запису, натисніть потрібне поле або кнопку "Редагувати". 
- Щоб переглянути або змінити посилання на інші записи на субпанелях, переключіть ліву нижню панель у режим "Перегляд даних". 
- Щоб залишити коментар, переглянути коментарі користувачів або записати журнал змін у {{activitystream_singular_module}}, переключіть ліву нижню панель у режим "Стрічка активності". 
- Щоб підписатися на даний запис або додати його до вподобань, використовуйте піктограми праворуч від назви запису. 
- Додаткові можливості доступні в спадному меню "Дії" праворуч від кнопки "Редагувати".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що відносяться до них, від початку до кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. 

Щоб створити {{module_name}}, виконайте вказані нижче дії. 
1. Укажіть потрібні значення полів. 
- Поля, позначені як "Обов&#39;язкові", необхідно заповнити перед збереженням.
 - За потреби натисніть кнопку "Показати більше", щоб відобразити додаткові поля. 
2. Натисніть кнопку "Зберегти", щоб завершити створення нового запису та повернутися на попередню сторінку.',
