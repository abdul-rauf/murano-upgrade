...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'تسمح وحدة {{plural_module_name}} بتتبع المبيعات الفردية من البداية إلى النهاية. يمثل كل سجل {{module_name}} مبيعات متوقعة ويتضمن بيانات مبيعات ذات صلة ويرتبط كذلك بسجلات مهمة أخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ. سوف تتقدم وحدة {{module_name}} بشكل نموذجي عبر مراحل المبيعات المتعددة حتى يتم تعليمها إما بـ "إغلاق لسبب الفوز" أو "إغلاق لسبب الفقد". يمكن زيادة {{plural_module_name}} أكثر باستخدام وحدة {{forecasts_singular_module}} من Sugar لفهم اتجاهات المبيعات والتنبؤ بها وكذلك التركيز على تحقيق نسب المبيعات.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'تسمح وحدة {{plural_module_name}} بتتبع المبيعات الفردية والبنود التي تنتمي إلى هذه المبيعات من البداية إلى النهاية. يمثل كل سجل {{module_name}} مبيعات متوقعة ويتضمن بيانات مبيعات ذات صلة ويرتبط كذلك بسجلات مهمة أخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ.

- قم بتحرير حقول هذا السجل بالنقر على حقل واحد أو الزر تحرير.
- قم بعرض الارتباطات إلى السجلات الأخرى أو عدلها في اللوحات الفرعية بتبديل الجزء الأيسر السفلي إلى "طريقة عرض البيانات".
- اصنع تعليقات المستخدمين واعرضها وسجل تاريخ التغييرات في {{activitystream_singular_module}} بتبديل الجزء السفلي الأيسر إلى "دفق النشاط".
- اتبع هذا السجل أو قم بتفضيله باستخدام الرموز الموجودة إلى يمين اسم السجل.
- تتوفر إجراءات إضافية في قائمة الإجراءات المنسدلة إلى يمين الزر تحرير.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'تسمح وحدة {{plural_module_name}} بتتبع المبيعات الفردية والبنود التي تنتمي إلى هذه المبيعات من البداية إلى النهاية. يمثل كل سجل {{module_name}} مبيعات متوقعة ويتضمن بيانات مبيعات ذات صلة ويرتبط كذلك بسجلات مهمة أخرى مثل {{quotes_module}} و{{contacts_module}}، إلخ.

لإنشاء {{module_name}}:
1. قم بتوفير قيم الحقول حسب الرغبة.
 -يجب إكمال الحقول الموضوع عليها علامة "مطلوب" قبل الحفظ.
 -انقر فوق "إظهار المزيد" للكشف عن حقول إضافية إذا تطلب الأمر.
