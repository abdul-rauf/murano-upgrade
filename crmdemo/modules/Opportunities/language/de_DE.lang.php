...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potentiellen Verkauf dar und umfasst sowohl relevante Verkaufsdaten als auch einen Bezug auf andere wichtige Datensätzewie z. B. {{quotes_module}}, {{contacts_module}}, etc. Ein {{module_name}} durchläuft in der Regel verschiedene Verkaufsphasen, bis er entweder die Markierung „Gewonnen“ oder „Verloren“ erhält. {{plural_module_name}} kann des Weiteren mithilfe von Sugars Modul {{forecasts_singular_module}} auch dazu genutzt werden, Trends bei Verkäufen besser zu verstehen sowie vorherzusagen und es erlaubt, die Arbeit noch mehr auf das Erreichen der Verkaufsquoten zu konzentrieren.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Mit dem Modul {{plural_module_name}} können Sie einzelne Verkäufe samt dazugehöriger Produkte von Anfang bis Ende nachverfolgen. Jeder Datensatz {{module_name}} stellt einen potentiellen Verkauf dar und umfasst die relevanten Verkaufsdaten sowie auch den Bezug zu anderen wichtigen Datensätzen, wie z. B. {{quotes_module}}, {{contacts_module}}, etc.

- Bearbeiten Sie die Felder in diesem Datensatz, indem Sie auf ein bestimmtes Feld oder auf die Schaltfläche „Bearbeiten“ klicken.
- Zeigen Sie Links zu anderen Datensätzen in den Unterfenstern an oder bearbeiten Sie diese, indem Sie das Fenster links unten auf „Datenansicht“ einstellen.
- Machen Sie Benutzerkommentare, zeigen Sie diese und die Datensatz-Änderungshistorie in {{activitystream_singular_module}} an, indem Sie das Fenster links unten auf „Aktivitäts-Stream“ einstellen.
...
2. Klicken Sie auf „Speichern“, um den neuen Datensatz fertigzustellen und zur letzten Seite zurückzukehren.',
