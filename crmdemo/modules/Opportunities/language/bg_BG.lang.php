...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} дава възможност за проследяване на отделните продажби от началото до края. Всеки запис в модула {{module_name}} представлява потенциална продажба и включва данни за съответната продажба, както и за други важни записи като {{quotes_module}}, {{contacts_module}} и т. н. {{module_name}} обикновено преминава през няколко Етапа на продажбата докато не бъде отбелязан като "Спечелен" или "Загубен". {{plural_module_name}} може да бъде разширен още с помощта на модула {{forecasts_singular_module}}ing на Sugar, за да бъдат разбрани и предсказани тенденциите в продажбите, както и за фокусиране на работата върху постигане на квотите за продажби.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} дава възможност за проследяване на всяка продажба и продуктите, асоциирани с продажбите от началото до края. Всеки запис в {{module_name}} представлява потенциална продажба и включва съответните данни за продажбата, както и такива отнасящи се до други важни записи като {{quotes_module}}, {{contacts_module}} и т. н.

- Редактирайте полетата на този запис като щракнете върху конкретно поле или използвате бутона „Редактирай“.
- Разгледайте или модифицирайте връзките към други записи в панелите със свързани данни като за целта визуализирате панела „Прегледай данни“ долу в ляво.
- Поставете нови, прегледайте коментарите на потребителите и запишете историята на извършените промени в {{activitystream_singular_module}} като визуализирате панела „Дейности“ долу в ляво.
- Следвайте или харесайте текущия запис като използвате иконите, намиращи се в дясно от името му.
- Можете да извършвате допълнителни действия със записа като използвате падащото меню Действия в дясно на бутона „Редактирай“.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} дава възможност за проследяване на отделните продажби и продуктите, асоциирани с тях от началото до края. Всеки запис в модула {{module_name}} представлява потенциална продажба и включва данни за съответната продажба, както и за други важни записи като {{quotes_module}}, {{contacts_module}} и т. н.
