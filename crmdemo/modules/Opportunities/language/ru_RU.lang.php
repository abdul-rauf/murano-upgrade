...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи от их начала и до самого конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и содержит необходимые данные о продаже, а также данные, касающиеся других важных записей, таких как {{quotes_module}}, {{contacts_module}} и т. д. Модуль {{module_name}} обычно проходит через несколько стадий продажи до тех пор, пока ему не будет присвоен статус "Успешно закрытая" или "Потерянная". Пользу от применения модуля {{plural_module_name}} можно увеличить, используя модуль {{forecasts_singular_module}} системы Sugar для понимания и прогнозирования тенденций продаж и фокусирования усилий на достижении установленных квот сбыта.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи и относящиеся к ним продукты от начала и до конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и содержит необходимые данные о продаже, а также данные, касающиеся других важных записей, таких как {{quotes_module}}, {{contacts_module}} и т. д. 

- Чтобы редактировать поля записи, нажмите на нужное поле или на кнопку "Редактировать". 
...
- Чтобы оставить и просмотреть комментарии или записать журнал изменений в {{activitystream_singular_module}}, переключите левую нижнюю панель в режим "Лента активности". 
- Чтобы подписаться на данную запись или добавить ее в "Избранное", используйте значки справа от названия записи. 
- Дополнительные возможности доступны в раскрывающемся меню "Действия" справа от кнопки "Редактировать".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи и относящиеся к ним продукты от начала и до конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и содержит необходимые данные о продаже, а также данные, касающиеся других важных записей, таких как {{quotes_module}}, {{contacts_module}} и т. д. 

Чтобы создать {{module_name}}, выполните приведенные ниже действия. 
1. Укажите необходимые значения полей.
 - Поля, помеченные как "Обязательные", следует заполнить перед сохранением.
 - При необходимости нажмите кнопку "Показать больше", чтобы отобразить дополнительные поля.
