...
// BEGIN PRO/CORP
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η λειτουργική μονάδα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε τις μεμονωμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει σχετική δεδομένα πώλησης καθώς και σχετικά με άλλες σημαντικές εγγραφές, όπως {{quotes_module}}, {{contacts_module}}, κλπ. Μια {{module_name}} συνήθως θα προχωρήσει μέσα από διάφορα στάδια πωλήσεων, έως ότου επισημανθεί είτε ως «Έκλεισε Κερδισμένη» είτε ως «Έκλεισε Χαμένη». Η {{plural_module_name}} μπορεί να ενισχυθεί ακόμη περισσότερο με τη χρήση της μονάδας {{forecasts_singular_module}}ing του Sugar για να κατανοήσετε και να προβλέψετε τις τάσεις των πωλήσεων, καθώς και να επικεντρωθείτε στην επίτευξη ποσοστώσεων πωλήσεων.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Η ενότητα {{plural_module_name}} σας δίνει τη δυνατότητα να παρακολουθείτε τις ξεχωριστές πωλήσεις και τα είδη γραμμής που περιλαμβάνονται στις συγκεκριμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια πιθανή πώληση και περιλαμβάνει τα σχετικά με την πώληση δεδομένα, καθώς και τη συσχέτιση με άλλες σημαντικές εγγραφές όπως {{quotes_module}}, {{contacts_module}}, κτλ.

- Τροποποιήστε τα πεδία της συγκεκριμένης εγγραφής κάνοντας κλικ σε συγκεκριμένο πεδίο ή στο πλήκτρο Τροποποίηση.
- Εμφανίστε ή τροποποιήστε συνδέσμους σε άλλες εγγραφές στους υποπίνακες, με εναλλαγή στο κάτω αριστερά παράθυρο μέχρι το «Εμφάνιση δεδομένων».
- Διατυπώστε και εμφανίστε σχόλια χρήστη και το ιστορικό αλλαγών εγγραφών στο {{activitystream_singular_module}} με εναλλαγή στο κάτω αριστερά παράθυρο μέχρι το «Ροή Δραστηριότητας».
- Ακολουθήστε ή χαρακτηρίστε ως αγαπημένη τη συγκεκριμένη εγγραφή με χρήση των εικονιδίων στα δεξιά του ονόματος αρχείου.
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού Ενεργειών στα δεξιά του πλήκτρου Τροποποιήσεων.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Η λειτουργική μονάδα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε τις μεμονωμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει δεδομένα σχετικά με την πώληση καθώς και σχετικά με άλλα σημαντικά αρχεία, όπως {{quotes_module}}, {{contacts_module}}, κλπ.
