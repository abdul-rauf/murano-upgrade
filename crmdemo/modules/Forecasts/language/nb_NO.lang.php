...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}. <br><br>Merk at innstillinger for område ikke kan endres etter første bruk. For oppgraderte tilfeller er områdeinnstillingen låst inn med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på sannsynlighetsområder, eller opprette kategorier som ikke er basert på sannsynlighet.<br><br>Det er avmerkingsbokser til venstre for dine tilpassede kategorier; bruk disse til å bestemme deg hvilke områder som skal inkluderres med prognosebeløpet og rapporteres til lederne.<br><br>En bruker kan endre inkluder/ekskluder-statusen og kategorien til {{forecastByModule}} manuelt fra arbeidsarket.',
