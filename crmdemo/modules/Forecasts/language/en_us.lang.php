...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configure how you would like to categorize {{forecastByModule}}. <br><br>Please note that the Range settings cannot be changed after the first commit. For upgraded instances, the Range setting is locked in with existing Forecast data.<br><br>You may select two or three categories based on probability ranges.<br><br>A user may change the include/exclude status and category of {{forecastByModule}} manually from their worksheet.',
