...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดค่าว่าคุณต้องการจัดประเภท {{forecastByModule}} อย่างไร<br><br>กรุณาระลึกไว้ว่าการตั้งค่าช่วงไม่สามารถเปลี่ยนแปลงได้หลังจากตกลงครั้งแรกไปแล้ว กรณีอัพเดต การตั้งค่าช่วงจะถูกล็อกด้วยข้อมูลคาดการณ์ที่มีอยู่<br><br>คุณอาจะเลือกประเภทสองประเภทหรือมากกว่าตามช่วงความน่าจะเป็นหรือสร้างประเภทที่ไม่เป็นไปตามความน่าจะเป็นขึ้นมา<br><br>มีกล่องกาเครื่องหมายอยู่ทางซ้ายของประเภทที่คุณกำหนดเอง; ใช้สิ่งเหล่านี้ในการตัดสินใจว่าช่วงไหนที่จะถูกรวมในจำนวนคาดการณ์ที่ยืนยันและรายงานแก่ผู้จัดการ<br><br>ผู้ใช้อาจจะเปลี่ยนแปลงสถานะรวม/ไม่รวมและประเภทของ{{forecastByModule}} เองจากแผ่นงานของพวกเขา',
