...
$mod_strings = array (
    ...
    'LBL_FORECASTS_RECORDS_ACLS_NO_ACCESS_MSG' => 'Du har inte tillgång till data i Prognosmodulen. Kontakta din administratör.',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Välj hur du vill kategorisera {{forecastByModule}}. <br><br>Notera att intervallinställningen inte kan ändras efter första commit. För uppgraderade instanser är intervallinställningen låst med befintlig prognosdata. <br><br>Du kan välja två eller fler kategorier baserade på sannolikhetsintervall eller skapa kategorier som inte baseras på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; använd dessa för att bestämma vilka serier som kommer att inkluderas inom Prognosbeloppet som commitas och rapporteras till chefer. <br><br>En användare kan välja att inkludera/exkludera status och kategori för {{forecastByModule}} manuellt från sina kalkylblad.',
    ...
    'LBL_FORECASTS_CONFIG_TIMEPERIODS_BACKWARD' => 'Välj hur många gångna tidsperioder som ska visas i arbetsbladet. <br><i>Antalet gäller bas-tidsperioden som valts. Exempelvis kommer 2 Kvartal att visa de senaste 6 månaderna</i>',
    ...
    'LBL_DASHLET_PIPELINE_CHART_DESC' => 'Visar aktuellt pipelinediagram.',
    ...
    'WARNING_DELETED_RECORD_RECOMMIT_1' => 'Posten inkluderades i en ',
    'WARNING_DELETED_RECORD_RECOMMIT_2' => 'Den kommer att tas bort, och du kommer att behöva återinchecka din ',
