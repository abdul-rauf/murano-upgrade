...
$mod_strings = array(
    ...
    'LBL_SELECT_DISCOUNT' => 'Alennus prosentteina',
    ...
    'LBL_CATEGORY_ID' => 'Tuotekategorian ID:',
    'LBL_QUANTITY' => 'Määrä:',
    'LBL_STATUS' => 'Tila:',
    ...
    'LBL_DISCOUNT_AMOUNT' => 'Alennuksen määrä',
    'LBL_TOTAL_DISCOUNT_AMOUNT' => 'Alennus yhteensä',
    ...
    'LBL_CONVERT_RLI_TO_QUOTE' => 'Luo tarjous tulojen tuoterivistä',
    ...
    'LBL_CONVERT_INVALID_RLI' => 'Yhtä tai useampaa valitsemaasi tuoteriviä ei voida muuttaa tarjoukseksi:<br /><br />',
    ...
    'LBL_CONVERT_INVALID_RLI_ALREADYQUOTED' => 'Tulotuoterivi on jo tarjottu.',
    ...
    'LBL_DISCOUNT_AS_PERCENT' => 'Alennus prosentteina',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}-moduuli tallentaa yksittäisiä liiketoiminnan tuoterivejä, jotka sisällytetään {{opportunities_singular_module}}-tietueeseen ja seurataan koko myyntiprosessin ajan. {{opportunities_singular_module}}-tietue toimii otsikkona yhdelle tai useammalle {{module_name}}-tietueelle. Tämä sallii tarkempaa tietojenkäsittelyä kun toimitaan {{opportunities_module}}- ja {{forecasts_singular_module}}-tietueiden kanssa, sillä kullakin {{opportunities_singular_module}}-tietueen tuoterivillä voi olla oma myyntitilanne ja {{forecasts_singular_module}} {{worksheet_module}}. {{module_name}} voi liittyä organisaatiosi tuotekatalogissa olevaan tuotteeseen. Näin tekemällä täytetään {{module_name}} automaattisesti tuotteen tiedot.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}-moduuli tallentaa yksittäisiä liiketoiminnan tuoterivejä, jotka sisällytetään {{opportunities_singular_module}}-tietueeseen ja seurataan koko myyntiprosessin ajan. {{opportunities_singular_module}}-tietue toimii otsikkona yhdelle tai useammalle {{module_name}}-tietueelle.
...
- Muut toiminnot löytyvät ‘Muokkaa’-painikkeen oikealla puolella olevasta ‘Toiminnot’-valikosta.',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}}-moduuli tallentaa yksittäisiä liiketoiminnan tuoterivejä, jotka sisällytetään {{opportunities_singular_module}}-moduuliin ja seurataan koko myyntiprosessin ajan. {{opportunities_singular_module}} toimii ikään kuin otsikkona {{module_name}}-tietueelle.
