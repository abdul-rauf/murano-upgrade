...
- Se eller ændr links til andre poster i underpaneler ved at skifte den nederste venstre rude til "Data View". 
...
- Følg eller favorisér denne post med ikonerne til højre for postens navn. 
- Yderligere handlinger er tilgængelige i dropdown menuen Handlinger til højre for knappen Rediger.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Den {{plural_module_name}} modul bruges til at spore og administrere produktrelaterede problemer, der almindeligvis omtales som {{plural_module_name}} eller defekter enten fundet internt eller rapporteret af kunderne.
