...
$mod_strings = array (
  ...
  'LBL_LIST_FIXED_IN_RELEASE' => 'Отстранен във версия',
...
- Можете да извършвате допълнителни действия със записа като използвате падащото меню в дясно на бутона „Редактирай“.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} се използва за проследяване и управление на проблеми в продуктите, често наричани {{plural_module_name}} или на дефекти, независимо дали са открити в организацията или са докладвани от клиенти.
