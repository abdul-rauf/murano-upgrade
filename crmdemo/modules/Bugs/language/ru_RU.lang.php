...
$mod_strings = array (
  // Dashboard Names
  'LBL_BUGS_LIST_DASHBOARD' => 'Информационная панель списка ошибок',
  'LBL_BUGS_RECORD_DASHBOARD' => 'Информационная панель записей ошибок',
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'Ответственный (-ая)',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} используется, чтобы отслеживать и управлять ошибками, связанными с продуктом, которые обычно называют {{plural_module_name}} или дефектами, обнаруженными внутри системы или клиентами. {{plural_module_name}} может быть в дальнейшем сортирован путем отслеживания обнаруженных и устраненных ошибок в новом релизе. Модуль {{plural_module_name}} предоставляет пользователям способ быстро просматривать все детали {{module_name}} и процесс для их исправления. Как только {{module_name}} создана или утверждена, Вы можете просмотреть и редактировать информацию, относящуюся к {{module_name}} в режиме просмотра записи {{module_name}}. Каждая запись {{module_name}} может быть затем связана с другими записями Sugar, такими как {{calls_module}}, {{contacts_module}}, {{cases_module}}, и многими другими.',
...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Редактировать.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} используется для отслеживания и управления ошибками, связанными с продуктом, которые обычно называют {{plural_module_name}} или дефектами, обнаруженными внутри системы или сообщенными клиентами.
