...
$mod_strings = array (
  ...
  'LBL_CONTACT_BUG_TITLE' => 'Yhteystieto-bugi:',
  'LBL_SUBJECT' => 'Aihe:',
  'LBL_BUG' => 'Bugi:',
  ...
  'ERR_DELETE_RECORD' => 'Tietuenumero tulee määritellä jotta voit poistaa bugin.',
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'Vastuukäyttäjä',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}-moduulilla seurataan ja hallitaan tuotteissa olevia ongelmia, joita kutsutaan {{plural_module_name}}. Bugeja voi löytää sisäisesti, tai ne voivat olla asiakkaiden raportoimia. {{plural_module_name}} voidaan myös seurata bugin korjauksen edistymistä. {{plural_module_name}}-moduuli tarjoaa käyttäjille nopean tavan tarkastella kaikkia {{module_name}} tietoja ja sen korjaamiseen käytettyä menetelmää. Kun {{module_name}} luodaan tai lähetetään, {{module_name}} tietoja voidaan näyttää ja muokata {{module_name}} tietuenäkymästä. Jokainen {{module_name}} voidaan linkittää muihin Sugar-tietueisiin, kuten {{calls_module}}, {{contacts_module}}, {{cases_module}} tai muihin.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}-moduulilla voidaan seurata ja hallita tuotteissa olevia ongelmia, joita kutsutaan termillä {{plural_module_name}}, tai virheitä, joita on löydetty sisäisesti tai joista asiakkaat ovat raportoinneet.

- Muokkaa tietueen kenttiä klikkaamalla itse kenttää tai Muokkaa-painiketta.

- Näytä tai muokkaa linkkejä muihin alipaneelien tietueisiin valitsemalla alavasemmalla oleva paneeli ‘tietonäkymään’.

- Luo ja näytä käyttäjäkommentteja ja tietueen historiaa {{activitystream_singular_module}}-näkymässä. Aktiviteettivirran saat esiin valitsemalla alavasemmalla olevan paneelin ‘aktiviteettivirta’-näkymään.
...
- Muut toiminnot löytyvät ‘Muokkaa’-painikkeen oikealla puolella olevasta ‘Toiminnot’-valikosta.',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}}-moduulia käytetään tuotteisiin liittyvien ongelmien seurantaan ja hallintaan, joista käytetään yleensä nimitystä {{plural_module_name}}, tai joko sisäisesti tai asiakkaiden ilmoittamiin virheisiin.
