...
$mod_strings = array (
  ...
  'ERR_DELETE_RECORD' => 'עליך לציין מספר תיעוד על מנת למחוק את הבאג.',
  ...
  'LBL_DEFAULT_SUBPANEL_TITLE' => 'מעקב באגים',
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'משתמשים שהוקצו',
    ...
    'LBL_EXPORT_FIXED_IN_RELEASE_NAMR' => 'תוקן בשם שחרור',
...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
    ...
    'LBL_HELP_CREATE' => 'המודול {{plural_module_name}} משומש למעקב וניהול בעיות הקשורות למוצר, שבדרך כלל נקראים {{plural_module_name}} או דפקטים, שנמצאו פנימית או שדווחו על ידי לקוחות.

כדי ליצור {{module_name}}:
1. ספק ערכים לשדות כפי שתרצה.
 - יש להשלים את השדות המסומנים כ"נדרשים" לפני השמירה.
 - לחץ על "הצג עוד" כדי להציג שדות נוספים אם נדרש.
2. לחץ על "שמור כדי לסיים את הרישום החדש ולחזור לדף הקודם.',
);
