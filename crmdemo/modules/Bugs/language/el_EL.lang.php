...
$mod_strings = array (
  ...
  'NTC_REMOVE_ACCOUNT_CONFIRMATION' => 'Είστε βέβαιοι ότι θέλετε να αφαιρέσετε αυτό το σφάλμα από αυτό τον λογαριασμό;',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} χρησιμοποιείται για να παρακολουθείτε και να διαχειρίζεστε τα προβλήματα που ανακύπτουν σε σχέση με τα προϊόντα, που συνήθως αναφέρονται ως {{plural_module_name}} ή ελαττωματικά, είτε εντοπίστηκαν κατά τη διάρκεια εσωτερικών ελέγχων, ή αναφέρθηκαν ως τέτοια από τους πελάτες.

Για να δημιουργήσετε {{module_name}}:
