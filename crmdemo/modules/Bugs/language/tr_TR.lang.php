...
$mod_strings = array (
  ...
  'LNK_CREATE'  => 'Hata Raporla',
  'LNK_CREATE_WHEN_EMPTY'    => 'Hatayı Bildirin.',
  'LNK_BUG_LIST' => 'Hataları Görüntüle',
  'LBL_SHOW_MORE' => 'Daha Fazla Hata Göster',
  ...
  'LNK_IMPORT_BUGS' => 'Hata Verilerini Yükle',
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'Atanan Kullanıcı',
	...
	'LBL_BUG_INFORMATION' => 'Genel Bilgi',

    //For export labels
	'LBL_FOUND_IN_RELEASE_NAME' => 'Bulunan Yayın İsmi',
    ...
    'LBL_EXPORT_FIXED_IN_RELEASE_NAMR' => 'Düzeltilen Yayın İsmi',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}} modülü, ürün ile ilgili problemlerin kayıt edilmesini ve takibini sağlar, genellikle {{plural_module_name}} veya üretim arızası şeklinde tanımlanır, şirket içinde veya müşteriler tarafından bildirilmiş olabilir. {{plural_module_name}}, bulunan ve düzeltilen versiyonları da içerebilir. {{plural_module_name}} modülü, {{module_name}} detaylarının kullanıcılar tarafından kolayca incelenmesini ve düzeltilmesi için gerekli akışın başlatılmasını sağlar. {{module_name}} oluşturulduğunda veya gönderildiğinde, {{module_name}} kaydına ait bilgileri, {{module_name}} modülü kayıt görüntüleme ekranından görüp düzeltebilirsiniz. Her {{module_name}} kaydı, {{calls_module}}, {{contacts_module}}, {{cases_module}} ve bunun gibi diğer Sugar kayıtları ile ilişkilendirilebilir.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} modülü, ürün ile ilgili problemleri takip etmek ve yönetmek için kullanılmaktadır, genellikle {{plural_module_name}} veya üretim hatası şeklinde tanımlanır, müşteri tarafından veya firma içinde bulunmuş olabilir. 

- Kaydın alanlarını, herhangi bir alana veya "Değiştir" tuşuna tıklayarak değiştirin.
- Alt bölmede bulunan diğer kayıtlara olan bağlantıları, sol alt bölmedeki "Veri Görünümü" değerine geçirerek görüntüleyin veya değiştirin.
...
- Kaydın isminin sağındaki ikonlara tıklayarak kaydı izleyiniz veya favori olarak işaretleyin.
- Daha fazla aksiyon, Değiştir tuşunun sağındaki Aksiyonlar seçimli menüde yer almaktadır.',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} modülü, ürün ile ilgili problemleri takip etmek ve yönetmek için kullanılmaktadır, genellikle {{plural_module_name}} veya hata olarak isimlendirilir, müşteri tarafından veya firma içinde bulunmuş olabilir. 
