...
$mod_strings = array (
  // Dashboard Names
  'LBL_BUGS_LIST_DASHBOARD' => 'Kļūdu saraksta instrumentu panelis',
  'LBL_BUGS_RECORD_DASHBOARD' => 'Kļūdu ierakstu instrumentu panelis',
  ...
  'LBL_CONTACT_BUG_TITLE' => 'Kontaktpersonas kļūda:',
  'LBL_SUBJECT' => 'Temats',
  'LBL_BUG' => 'Kļūda:',
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => 'Piešķirtais lietotājs',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulis „{{plural_module_name}}” tiek izmantots, lai izsekotu un pārvaldītu ar produktu saistītas problēmas, kas parasti tiek dēvētas par „{{plural_module_name}}” vai defektiem un kas ir gan pašu atrastas, gan klientu pieteiktas. Moduli „{{plural_module_name}}” vēlāk var izmantot, izsekojot versijā atrastās un izlabotās kļūdas. Modulis „{{plural_module_name}}” ļauj lietotājiem ātri caurskatīt moduļa "{{module_name}}” informāciju un labošanā izmantoto procesu. Kad modulis „{{module_name}}” ir izveidots vai iesniegts, informāciju par moduli „{{module_name}}” var aplūkot un rediģēt moduļa „{{module_name}}” ierakstu skatījuma režīmā. Katrs moduļa „{{module_name}}” ieraksts var tikt saistīts ar citiem „Sugar” ierakstiem, piemēram, moduļiem „{{calls_module}}”, „{{contacts_module}}”, „{{cases_module}}” un daudziem citiem.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}} modulis tiek izmantots, lai izsekotu un pārvaldītu ar produktu saistītās problēmas, kas parasti tiek dēvētas par {{plural_module_name}} vai defektiem, gan pašu atrastas, gan klientu pieteiktas.

- Rediģējiet ieraksta laukus, klikšķinot uz laukiem vai pogas Rediģēt.
- Apskatiet vai rediģējiet saites uz citiem ierakstiem apakšējos paneļos, ieslēdzot datu skatu kreisajā apakšējā panelī.
...
- Sekojiet šim ierakstam vai atzīmējiet kā favorītu, izmantojot ikonas pa labi no ieraksta nosaukuma.
- Papildu darbības pieejamas izkrītošajā darbību izvēlnē pa labi no Rediģēšanas pogas.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulis {{plural_module_name}} tiek izmantots, lai reģistrētu un pārvaldītu ar produktu saistītās problēmas, kas parasti tiek reģistrētas kā {{plural_module_name}} vai defekti, gan pašu atrastas gan klientu pieteiktās.
