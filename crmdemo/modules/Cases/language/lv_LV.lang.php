...
$mod_strings = array (
	...
	'LBL_CASE'							=> 'Pieteikums:',
	'LBL_CONTACT_CASE_TITLE'			=> 'Kontaktpersona-pieteikums:',
	...
	'LBL_MODULE_TITLE'					=> 'Pieteikumi: Sākums',
    ...
    'LBL_CASE_FROM_TWITTER_TITLE'		=> 'Tvīts',
	...
	'LBL_LIST_DATE_CREATED'			=> 'Izveides datums',
    ...
    'LBL_ASSIGNED_USER_NAME_OWNER' => 'Piešķirtais lietotājs (Atbildīgais)',
    'LBL_ASSIGNED_USER_NAME_MOD' => 'Piešķirtais lietotājs (Modificētājs)',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulis „{{plural_module_name}}” tiek izmantots, lai izsekotu un pārvaldītu ar produktu vai pakalpojumu saistītas problēmas, par ko jūsu uzņēmumu informējuši klienti. Moduļi „{{plural_module_name}}” parasti ir saistīti ar moduļa „{{accounts_singular_module}}” ierakstu, un vairāki moduļi „{{plural_module_name}}” var būt saistīti atsevišķi ar moduli „{{accounts_singular_module}}”. Ir vairāki veidi, kā izveidot moduli „{{plural_module_name}}” vietnē „Sugar”, piemēram, izmantojot moduli „{{plural_module_name}}”, importējot moduli „{{plural_module_name}}” vai konvertējot no e-pasta. Kad modulis „{{module_name}}” ir izveidots, informāciju par moduli „{{module_name}}” var aplūkot un rediģēt moduļa „{{module_name}}” ierakstu skatījuma režīmā. Katrs moduļa „{{module_name}}” ieraksts var tikt saistīts ar jebkuriem citiem „Sugar” ierakstiem, piemēram, moduļiem „{{calls_module}}”, „{{contacts_module}}”, „{{bugs_module}}” un daudziem citiem.',
...
- Papildus darbības pieejamas izkrītošajā darbību izvēlnē pa labi no Rediģēšanas pogas.',
    ...
    'LBL_HELP_CREATE' => 'Modulis {{plural_module_name}} paredzēts ar produktiem vai pakalpojumiem saistītu problēmu reģistrēšanai un pārvaldībai, par kurām ir ziņojuši jūsu klienti.
