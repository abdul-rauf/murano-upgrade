...
$mod_strings = array (
    ...
    'LBL_ASSIGNED_USER_NAME_OWNER' => 'Όνομα Ιδιοκτήτη Ανατεθειμένου Χρήστη',
    'LBL_ASSIGNED_USER_NAME_MOD' => 'Όνομα Διαμορφωτή Ανατεθειμένου Χρήστη',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} χρησιμοποιείται για την παρακολούθηση και διαχείριση προϊόντος ή την επίλυση συναφών προβλημάτων που αναφέρθηκαν στον οργανισμό σας από τους πελάτες.
