...
- Додаткові дії доступні у випадаючому меню Кнопка Дій знаходиться праворуч від кнопки Редагувати.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} використовується для віжстеження і керування помилками, пов&#39;язаними з продуктом або послугою, про які Вашій організації повідомляють клієнти.
