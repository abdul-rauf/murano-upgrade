...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Редактировать.',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} используется для отслеживания и управления ошибками, связанными с продуктом или услугой, о которых Вашей организации сообщают клиенты.
