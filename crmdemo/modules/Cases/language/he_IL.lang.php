...
$mod_strings = array (
    ...
    'LBL_MODIFIED_BY_NAME_MOD' => 'מוד נערך על ידי שם',
    'LBL_CREATED_BY_NAME_OWNER' => 'נוצר על ידי שם הבעלים',
    'LBL_CREATED_BY_NAME_MOD' => 'מוד נוצר על ידי שם',
    'LBL_ASSIGNED_USER_NAME_OWNER' => 'הוקצה למשתמש ששם הבעלים',
    'LBL_ASSIGNED_USER_NAME_MOD' => 'מוד שם משתמש מוקצה',
    'LBL_TEAM_COUNT_OWNER' => 'מונה צוות בעלים',
    'LBL_TEAM_COUNT_MOD' => 'מוד מונה צוות',
    'LBL_TEAM_NAME_OWNER' => 'שם בעל הצוות',
    'LBL_TEAM_NAME_MOD' => 'מוד שם צוות',
    'LBL_ACCOUNT_NAME_OWNER' => 'שם בעל חשבון',
    'LBL_ACCOUNT_NAME_MOD' => 'מוד שם חשבון',
    'LBL_MODIFIED_USER_NAME' => 'שם משתמש ששינה',
    'LBL_MODIFIED_USER_NAME_OWNER' => 'שם משתמש ששינה בעלים',
    'LBL_MODIFIED_USER_NAME_MOD' => 'מוד שם משתמש ערוך',
...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
    ...
    'LBL_HELP_CREATE' => 'המודול {{plural_module_name}} משומש כדי לעקוב ולנהל בעיות הקשורות למוצר או שירות שלקוחות מדווחים לארגון שלך
