...
$mod_strings = array (
  ...
  'LBL_EMAIL_ADDRESSES' => 'E-posti aadress(id)',
  'LBL_PUSH_BILLING' => 'Push Billing',
  'LBL_PUSH_SHIPPING' => 'Push Shipping',
  'LBL_TICKER_SYMBOL' => 'Tikkeri sümbol:',
  'LBL_FAX' => 'Fax:',
  'ACCOUNT_REMOVE_PROJECT_CONFIRM' => 'Kas oled kindel, et soovid selle ettevõtte projektist eemaldada?',
  ...
  'MSG_DUPLICATE' => 'Selle konto loomine võib potentsiaalselt luua duplikaatkonto. Vali konto allolevast loendist või kliki Salvesta uue konto loomise jätkamseks juba eelnevalt sisestatud andmetega.',
  'MSG_SHOW_DUPLICATES' => 'Selle konto loomine võib potentsiaalselt luua duplikaatkonto. Kliki Salvesta uue konto loomiseks juba varemsisestatud andmetega või kliki Tühsta.',
  ...
  'NTC_REMOVE_MEMBER_ORG_CONFIRMATION' => 'Oled kindel, et soovid selle kirje eemaldada tütarettevõttena?',
  'LBL_LIST_FORM_TITLE' => 'MSA Loend',
  'LBL_MODULE_NAME' => 'MSA',
  'LBL_MODULE_TITLE' => 'MSA',
  'LBL_MODULE_NAME_SINGULAR' => 'MSA',
  'LBL_HOMEPAGE_TITLE' => 'Minu MSA',
  'LNK_NEW_RECORD' => 'Loo MSA',
  'LNK_LIST' => 'Vaade MSA',
  'LNK_IMPORT_MUR_MSA' => 'Import MSA',
  'LBL_SEARCH_FORM_TITLE' => 'Otsi MSA',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Vaata ajalugu',
  'LBL_MUR_MSA_SUBPANEL_TITLE' => 'MSA',
  'LBL_NEW_FORM_TITLE' => 'Uus MSA',
  'LNK_IMPORT_VCARD' => 'Import MSA vCard',
  'LBL_IMPORT' => 'Import MSA',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new MSA record by importing a vCard from your file system.',
  'LBL_LAST_NAME' => 'Last Name',
  'LBL_ACT_DATE' => 'Licence Activation Date',
  'LBL_EXPIRY_DATE' => 'Licence Expiry Date',
);