...
$mod_strings = array (
    ...
    'LBL_DIRECT_REPORTS_SUBPANEL_TITLE'=>'Informes Directos',
    ...
    'LBL_EXISTING_ACCOUNT' => 'Se ha utilizado una cuenta existente',
    'LBL_EXISTING_CONTACT' => 'Se ha utilizado un contacto existente',
    'LBL_EXISTING_OPPORTUNITY'=> 'Se ha utilizado una oportunidad existente',
    'LBL_FAX_PHONE' => 'Fax:',
    ...
    'LBL_VCARD' => 'vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Crear automáticamente un nuevo contacto mediante la importación de una vCard del sistema de archivos.',
    ...
    'LBL_PRODUCTS_TITLE'=>'Elementos presupuestados',
    ...
    'LBL_SYNC_CONTACT' => 'Sincronizar con el cliente de email:',
    ...
    'MSG_DUPLICATE' => 'El registro para el contacto que va a crear podría ser un duplicado de otro registro de contacto existente. A continuación se enumeran registros que contienen nombres similares.<br>Haga clic en Crear contacto para continuar con la creación de este contacto, o seleccione un contacto existente de la siguiente lista.',
    'MSG_SHOW_DUPLICATES' => 'El registro para el contacto que va a crear podría ser un duplicado de otro registro de contacto existente. Los registros de contacto con nombres y/o direcciones de email similares se enumeran a continuación.<br>Haga clic en Guardar para continuar con la creación de este contacto, o en Cancelar para volver al módulo sin crear el contacto.',
    ...
    'LBL_COPY_ADDRESS_CHECKED_PRIMARY' => 'Copiar a la dirección principal',
    ...
    'LBL_LANG_PREF_TOOLTIP' => 'El interfaz de usuario del Portal de Asistencia se generará en el idioma seleccionado aquí',
...
- Ver o modificar enlaces a otros registros en los subpaneles alternando el panel inferior izquierdo con "Ver Datos".
- Comentar o ver otros comentarios de usuarios y registrar el historial del registro en {{activitystream_singular_module}} alternando el panel inferior izquierdo con "Flujo de Actividades".
- Seguir o guardar como favorito el registro utilizando los iconos a la derecha del nombre del registro. 
- Acciones adicionales están disponibles en el menú desplegable de Acciones a la derecha del botón Editar.',
