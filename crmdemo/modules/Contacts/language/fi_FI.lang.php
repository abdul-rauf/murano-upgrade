...
$mod_strings = array (
    ...
    'LBL_DIRECT_REPORTS_SUBPANEL_TITLE'=>'Suora raportointi',
    ...
    'LBL_STATE' => 'Osavaltio:',
    'LBL_SYNC_CONTACT' => 'Synkronoi postiasiakkaaseen:',
    ...
    'MSG_DUPLICATE' => 'Kontaktitietue, jota olet luomassa, saattaa olla kopio jo olemassa olevasta tietueesta. Samankaltaisesti nimetyt kontaktitietueet on listattu alle.<br>Klikkaa Luo kontakti luodaksesi tämän uuden kontaktin, tai valitse olemassa oleva, alla listattu kontakti.',
    'MSG_SHOW_DUPLICATES' => 'Kontaktitietue, jonka aiot luoda, saattaa olla kopio jo olemassa olevasta tietueesta. Samankaltaisesti nimetyt kontaktitietueet on listattu alle.<br>Napsauta Tallenna luodaksesi tämän kontaktin, tai napsauta Peruuta palataksesi moduuliin luomatta kontaktia.',
    ...
    'LBL_PORTAL_PASSWORD' => 'Portaalin salasana',
    'LBL_CONFIRM_PORTAL_PASSWORD' => 'Vahvista portaalin salasana',
    'LBL_LANG_PREF_TOOLTIP' => 'Tukiportaalin käyttöliittymä näytetään tässä valitulla kielellä',
    'LBL_CONTACT_EDIT_PASSWORD' => 'Salasana',
    'LBL_CHECKOUT_DATE'=>'Uloskirjautumispäivämäärä',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}-moduuli tallentaa tietoja yksittäisistä henkilöistä, joilla organisaatiollasi on suhde. {{module_name}}-tietueet liittyvät yleensä {{accounts_singular_module}}-tietueeseen, ja yhteen {{accounts_singular_module}}-tietueeseen voidaan assosioida monta {{plural_module_name}}-tietuetta. {{plural_module_name}}-tietueen voi Sugarissa luoda monella tapaa, kuten{{plural_module_name}}-moduulissa itsessään, tuomalla {{plural_module_name}}, muuntamalla {{leads_module}} {{plural_module_name}}, ym. Kun {{module_name}}-tietue on luotu, voit katsella ja muokata {{module_name}} tietoja {{plural_module_name}}-näkymästä. Jokainen {{module_name}}-tietue voidaan linkittää toisiin Sugarin tietueisiin, kuten {{meetings_module}}, {{cases_module}}, {{opportunities_module}}, ja muihin, tehden {{module_name}}-tietueesta keskuksen suhteesta kyseiseen henkilöön.',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}-moduuli tallentaa tietoja yksittäisistä henkilöistä, joilla organisaatiollasi on suhde.
...
- Muut toiminnot löytyvät ‘Muokkaa’-painikkeen oikealla puolella olevasta ‘Toiminnot’-valikosta.',
    ...
    'LBL_HELP_CREATE' => '{{plural_module_name}}-moduuli tallentaa tietoja yksittäisistä henkilöistä, joilla organisaatiollasi on suhde. {{module_name}} luonnin vaiheet:
