...
$mod_strings = array (
    ...
    'LBL_LIST_NAME' => 'Namn',
    'LBL_LIST_OTHER_EMAIL_ADDRESS' => 'Annan email',
    ...
    'LBL_HELP_RECORD' => '{{plural_module_name}}modulen består av enskilda människor som din organisation har en relation till.

- Redigera postens fält genom att klicka på ett fält eller på knappen Redigera. 
- Visa eller ändra länkar till andra poster i underpaneler genom att växla den nedre vänstra rutan till "Datavy".
 - Skapa och visa användarkommentarer och se förändringar i {{activitystream_singular_module}} genom att växla den nedre vänstra rutan till "Aktivitetsström". 
- Följ eller favoritmarkera med hjälp av ikonerna till höger om namnet. 
- Ytterligare åtgärder finns i dropdown-menyn Åtgärder till höger om knappen Redigera.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Modulen {{plural_module_name}} består av individer din organisation har något förhållande till.
