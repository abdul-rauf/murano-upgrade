...
$mod_strings = array (
    ...
    'LBL_DIRECT_REPORTS_SUBPANEL_TITLE'=>'Tiešās atskaites',
    ...
    'LBL_VCARD' => 'vCard',
    'LBL_IMPORT_VCARDTEXT' => 'Automātiski veidot jaunu kontaktpersonu, importējot vizītkarti.',
    ...
    'LBL_OFFICE_PHONE' => 'Biroja tālruņa numurs',
    ...
    'LNK_IMPORT_VCARD' => 'Izveidot kontaktpersonu no vizītkartes',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modulī „{{plural_module_name}}” iekļauts atsevišķu personu saraksts, ar kurām jūsu uzņēmums ir saistīts. Moduļa „{{module_name}}” ieraksti parasti ir saistīti ar moduļa „{{accounts_singular_module}}” ierakstu, un vairāki moduļi „{{plural_module_name}}” var būt saistīti ar atsevišķu moduli „{{accounts_singular_module}}”. Ir vairāki veidi, kā izveidot moduli „{{plural_module_name}}” vietnē „Sugar”, piemēram, izmantojot moduli „{{plural_module_name}}”, importējot moduli „{{plural_module_name}}” vai konvertējot moduli „{{leads_module}}” modulī „{{plural_module_name}}” utt. Kad moduļa „{{module_name}}” ieraksts ir izveidots, informāciju par moduli „{{module_name}}” var aplūkot un rediģēt moduļa „{{plural_module_name}}” ierakstu skatījuma režīmā. Katrs moduļa „{{module_name}}” ieraksts var tikt saistīts ar citiem „Sugar” ierakstiem, piemēram, moduļiem „{{meetings_module}}”, „{{cases_module}}”, „{{opportunities_module}}” un daudziem citiem, padarot moduļa „{{module_name}}” ierakstu par mezglu, no kura var skatīt un turpināt mijiedarbību ar konkrētu personu.{{plural_module_name}}{{plural_module_name}}',
...
- Papildus darbības pieejamas izkrītošajā darbību izvēlnē pa labi no Rediģēšanas pogas.',
    ...
    'LBL_HELP_CREATE' => 'Modulis {{plural_module_name}} satur individuālas personas, ar kurām jūsu organizācijai ir attiecības.
