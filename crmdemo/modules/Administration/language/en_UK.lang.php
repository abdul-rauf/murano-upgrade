...
$mod_strings = array (
	...
	'ERR_NUM_OFFLINE_CLIENTS_MET' => 'You have already met the number of Offline Clients for your licence key.  You must either disable an existing Offline Client or update your licence.',
	...
	'ERR_UW_ACCEPT_LICENSE'                  => 'Before proceeding you must accept the Licence Agreement',
    ...
    'ERR_UW_NOT_RECOGNIZED'                     => 'is not recognised',
    ...
    'FATAL_LICENSE_ALTERED' => "Your licence has been altered since the last time you validated it. <br> Please go to the <a href='index.php?action=LicenseSettings&module=Administration'>'\"Licence Management\"</a>  in the Admin screen.",
    'FATAL_LICENSE_EXPIRED'=> "Fatal: Your licence expired more than 30 days ago",
    'FATAL_LICENSE_EXPIRED2'=> "Please go to the <a href='index.php?action=LicenseSettings&module=Administration'>'\"Licence Management\"</a>  on the Admin page to update your licence information and restore full functionality.",
    'FATAL_LICENSE_REQUIRED' => "Fatal: Your licence key information is required .<br>   Please go to the <a href='index.php?action=LicenseSettings&module=Administration'>'\"Licence Management\"</a>  in the Admin screen to update your licence information and restore full functionality.",
    'FATAL_VALIDATION_EXPIRED'=> "Fatal: Your validation key expired more than 30 days ago",
    'FATAL_VALIDATION_EXPIRED2'=> "Please go to the <a href='index.php?action=LicenseSettings&module=Administration'>'\"Licence Management\"</a>  in the Admin screen to update your licence information and restore full functionality.",
    'FATAL_VALIDATION_REQUIRED' => "Fatal: Your validation key information is required .<br>   Please go to the <a href=&#39;index.php?action=LicenseSettings&module=Administration&#39;>&#39;\"Licence Management\"</a>  in the Admin screen to update your licence information and restore full functionality.<br>Either re-save your licence information to have it authenticated or export the key and import the validation key." ,
    'HDR_LOGIN_PANEL'          => 'Please enter your sugarcrm.com credentials.',
    'HEARTBEAT_MESSAGE'=>"<BR>The Sugar Updates mechanism allows your server to check to see if an update for your version of Sugar is available.",
    ...
    'LBL_ADMINISTRATION_HOME_DESC' =>'Configure the system-wide settings according to the specifications of your organisation. Users can override some of the default locale settings within their user settings page.',
    ...
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your Sugar application files in a .zip file, enter the following information:',
    ...
    'LBL_EXPORT_METADATA_BUTTON_TITLE' => 'Export Metadata File',
    'LBL_EXPORT_METADATA_BUTTON_LABEL' => 'Export Metadata File',
    'LBL_IMPORT_METADATA_BUTTON_TITLE' => 'Import IdP Metadata File',
    'LBL_IMPORT_METADATA_BUTTON_LABEL' => 'Import IdP Metadata File',
    ...
    'LBL_CLEAR_ADDITIONAL_CACHE_DESC' => 'Removes cached files used by additional resources (API, etc)',
    'LBL_CLEAR_ADDITIONAL_CACHE_TITLE' => 'Clear Additional Cache',
    'LBL_CLEAR_ADDITIONAL_CACHE_FINDING' => 'Finding files...',
    'LBL_CLEAR_ADDITIONAL_CACHE_DELETING' => 'Deleting additional cache files...',
	...
	'LBL_CONFIG_TABS_DESC'=>'Drag and Drop the names of the modules below to set them to be displayed or hidden in the top navigation bar or as sub-panels. To control access to modules, use <a href="?module=ACLRoles&action=index">Role Management.</a>',
    ...
    'LBL_CONFIGURE_TABS_AND_SUBPANELS' => 'Select Module Tabs and Subpanels',
    ...
    'LBL_DOCUMENTATION' => 'View Sugar documentation for administrators and end-users',
    'LBL_DONE'  => 'Done',
    ...
    'LBL_INBOUND_EMAIL_TITLE' => 'Group Mail Account',
    ...
    'LBL_LICENSE_NUM_LIC_OC'           => 'Number of Offline Client Licences',
    ...
    'LBL_LICENSE_VALIDATION'           => 'Licence Validation',
    'LBL_LICENSE'               => 'Licence',
    'LBL_LICENSE_UNAUTHORIZED_ACCESS'               => 'Unauthorised access to licence settings.',
    ...
    'LBL_MANAGE_LICENSE_TITLE'  => 'Licence Management',
    'LBL_MANAGE_LICENSE'        => 'Manage licence properties',
    'LBL_MANAGE_LOCALE' => 'Locale',
    'LBL_MANAGE_MAILBOX' => 'Group Mail Account',
    ...
    'LBL_MANAGE_FORECASTS' => 'Configure Forecasts Module',
...
If your system environment prohibits your system from communicating to the licence validation server through the internet, you should proceed with the <a href="javascript:void(0)" onclick="toggleDisplay(&#39;mainbody&#39;);toggleDisplay(&#39;manualbody&#39;);">Manual Validation</a> steps. ',
    ...
    'LBL_MASS_EMAIL_CONFIG_DESC' => 'Configure the email account Sugar uses to send system emails ' .
        ...
        ' email options for the organisation and email security.',
    ...
    'LBL_MODULE_LICENSE'                        => 'Please read the following Licence Agreement:',
    ...
    'LBL_PASSWORD_SUGAR_SERVER_DESC'        => '- An Admin username and password on the server',
    ...
    'LBL_PASSWORD_ONLY_LOWCASE' => 'Only lowcase characters',
    ...
    'LBL_PASSWORD_NEEDED_CARACTERS' => 'Needed characters',
    'LBL_PASSWORD_PROHIBITED_CARACTERS' => 'Prohibited characters',
    ...
    'LBL_PRICE_LIST_DESC' => 'Manage the product catalogue, along with the related information on manufacturers and shipping providers.',
    ...
    'LBL_PRODUCTS_TITLE' => 'Product Catalogue',
    'LBL_PRODUCTS' => 'Enter items in the product catalogue',
    ...
    'LBL_REBUILD_AUDIT_REPAIR' => 'Audit table for %1$s has been repaired.<BR>',
...
//END SUGARCRM flav=een
    'LBL_REBUILD_FULL_TEXT_ABORT' => 'Unauthorised Access. Aborting.',
    ...
    'WARN_INSTALLER_LOCKED'=>'<b>Warning:</b> To safeguard your data, the installer must be locked by setting &#39;installer_locked&#39; to &#39;true&#39; in the config.php file.',
 	'WARN_LICENSE_EXPIRED'=> "Notice: Your licence expires in",
    'WARN_LICENSE_EXPIRED2' =>" day(s). Please go to the <a href='index.php?action=LicenseSettings&module=Administration'>'\"Licence Management\"</a>  in the Admin screen.",
    'WARN_LICENSE_SEATS'=>  "Warning: User licences exceeded by",
    ...
    'WARN_LICENSE_SEATS_MAXED'=>  "Warning: The number of active users is already the maximum number of licences allowed:",
    'WARN_LICENSE_SEATS_EDIT_USER'=>  "Warning: The number of active users is already the maximum number of licences allowed",
    'WARN_LICENSE_SEATS_USER_CREATE'=>"Warning: The number of active users allowed by your licence matches the number of active users in the system. You will not be able to create additional active users.",
    ...
    'WARN_VALIDATION_EXPIRED2' =>"day(s). Please update information in the <a href=&#39;index.php?action=LicenseSettings&module=Administration&#39;>&#39;\"Licence Management\"</a> page in the Admin area.",
	...
	'LBL_MODULE_UPLOAD_DISABLE_HELP_TEXT' => 'New uploads for Module Loader are disabled. Installable modules are restricted to the modules pre-loaded below. You may submit a SugarCRM Support case to review additional modules that you wish to load.',
...
'ML_LANGUAGE_FILE_KEYS_INVALID'=>'Key - may only consist of letters, numbers and underscores. ',
    ...
    'LBL_SAML_SP_ENTITY_ID' => 'SugarCRM Entity ID',
    ...
    'LBL_GLOBAL_SEARCH_SETTINGS_TITLE' => 'Full text search will be used to return results for a global search in the desktop application. In order for results to return for a particular module, it must be enabled below. Make sure to perform a full system index after enabling modules for full text search. Individual module fields can be enabled for full text search via <a href="index.php?module=ModuleBuilder&action=index&type=studio">Studio</a>. <br> To enable modules for global searches in SugarCRM Mobile and Sugar Portal, please use the <a href="index.php?module=Administration&action=UnifiedSearchSettings">Legacy Global Search Configuration</a>. <br> For more information, refer to the <a href="http://www.sugarcrm.com/crm/product_doc.php?edition=ENT&version=7.7.0.0beta4&lang=en_us&module=FullTextSearch">Search</a> documentation.',
    'LBL_UNIFIED_SEARCH_SETTINGS_TITLE' => 'Legacy global search will only be used to return results in SugarCRM Mobile or Sugar Portal global searches. In order for legacy global search to perform a search on a particular module, it must be enabled below. <br> To enable modules for global search in the desktop application, use the <a href="index.php?module=Administration&action=GlobalSearchSettings">Full Text Search Configuration</a>. <br> For more information, refer to the <a href="http://www.sugarcrm.com/crm/product_doc.php?edition=ENT&version=7.7.0.0beta4&lang=en_us&module=LegacyGlobalSearch">Search</a> documentation.',
...
Any integrations that rely on this platform will stop working.',
    ...
    'LBL_DIAGNOSTICS_VARDEFS_VERSIONS' => '<P>Sugar version:  {0} / Sugar DB version:  {1} / Sugar flavour:  {2}',
    'LBL_DIAGNOSTICS_VARDEFS_TABLE' => 'Table:',
    'LBL_DIAGNOSTICS_VARDEFS_COLUMN' => 'Column',
