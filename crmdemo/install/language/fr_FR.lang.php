...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Le support de base de données est introuvable. Veuillez vous assurer d\'avoir les pilotes nécessaires pour un des types de bases de données pris en charge suivants : MySQL, MS SQLSErver, Oracle, ou DB2. Vous devrez éventuellement décommenter l\'extension dans le fichier php.ini ou recompiler avec le fichier binaire correct, selon votre version de PHP. Veuillez consulter votre manuel PHP pour plus d\'informations sur la façon d\'activer le support de base de données.',
