...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Suportul de baze de date nu a fost găsit.  Vă rugăm să vă asiguraţi că aveţi driverele necesare pentru unul dintre următoarele tipuri de baze de date suportate: MySQL, MS SQLServer, Oracle sau DB2.  Va trebui să anulați comentariile la extensia din fişierul php.ini sau să recompilaţi cu fişierul binar corect, în funcţie de versiunea PHP.  Vă rugăm să consultaţi manualul PHP pentru mai multe informaţii despre cum să activaţi suportul pentru baze de date.',
