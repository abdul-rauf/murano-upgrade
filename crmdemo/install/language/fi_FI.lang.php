...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Tietokantatukea ei löytynyt. Varmista, että sinulla on tarvittavat ajurit jollekin seuraavista tuetuista tietokantatyypeistä: MySQL, MS SQLServer, Oracle tai DB2. Sinun täytyy ehkä poistaa kommenttimerkintä laajennuksen edestä php.ini-tiedostossa tai kääntää uudelleen oikealla binääritiedostolla riippuen PHP-versiostasi. Katso lisätietoa tietokantatuen käyttöönotosta PHP-oppaasta.',
