...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se ha encontrado el soporte de base de datos. Asegúrese de tener los controladores necesarios para alguno de los siguientes tipos de Base de Datos compatibles: MySQL, MS SQLServer, Oracle o DB2. Es posible que tenga que descomentar la extensión en el archivo php.ini, o recompilarlo con el archivo binario apropiado, dependiendo de la versión de PHP. Consulte el manual de PHP para obtener más información sobre cómo habilitar el Servicio de soporte de base de datos.',
