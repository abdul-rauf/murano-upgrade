...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'El suport de la base de dades no s\'ha trobat. Comproveu que teniu els controladors necessàris per a algún dels típus de bases de dades suportats següents: MySQL, MS SQLServer, Oracle, or DB2. Potser necessiteu descomentar l\'extensió en el fitxer php.ini, o recompilar-lo amb el fitxer binàri apropiat, depenent de la vostra versió PHP. Siusplau, acudiu al vostre manual PHP per a més informació sobre com actuvar el suport de la base de dades.',
