...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databaseondersteuning werd niet gevonden. Controleer of u de nodige drivers hebt voor een van de volgende ondersteunde databasetypes: MySQL, MS SQLServer, Oracle of DB2. Mogelijk moet u de extensie in het php.ini bestand verwijderen of moet u, afhankelijk van uw versie van PHP, opnieuw compileren met het juiste binaire bestand. Raadpleeg uw PHP handleiding voor meer informatie over hoe u databaseondersteuning inschakelt.',
