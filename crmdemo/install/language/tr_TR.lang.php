...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veritabanı Desteği bulunamadı. Lütfen desteklenen şu Veritabanı Türlerinden biri için gerekli sürücülere sahip olduğunuzdan emin olun: MySQL, MS SQLServer, Oracle veya DB2. Php.ini dosyasındaki uzantı açıklamasını kaldırmanız veya PHP sürümünüze bağlı olarak doğru ikili dosya ile tekrar derlemeniz gerekebilir. Lütfen Veritabanı Desteği Etkinleştirme ile ilgili daha fazla bilgi için PHP Kılavuzuna başvurun.',
