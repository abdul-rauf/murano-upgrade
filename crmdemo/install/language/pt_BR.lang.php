...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O suporte ao banco de dados não foi encontrado. Certifique-se de que você tem os drivers necessários para um dos seguintes tipos de banco de dados suportados: MySQL, MS SQLServer, Oracle ou DB2. Talvez seja necessário remover o comentário da extensão no arquivo php.ini ou recompilar com o arquivo binário correto, dependendo da versão do PHP. Consulte o Manual do PHP para obter mais informações sobre como ativar o suporte ao banco de dados.',
