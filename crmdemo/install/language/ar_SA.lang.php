...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'لم يتم العثور على دعم قاعدة البيانات. الرجاء التأكد من توفر برامج التشغيل اللازمة المناسبة لأحد أنواع قواعد البيانات المدعمة التالية: MySQL أو MS SQLServer أو Oracle أو DB2. قد تحتاج إلى إلغاء التعليق على الامتداد الموجود في ملف php.ini، أو إعادة التحويل البرمجي باستخدام الملف الثنائي المناسب، وذلك حسب إصدار PHP الموجود لديك. الرجاء الرجوع إلى دليل PHP الموجود لديك لمزيد من المعلومات حول كيفية تمكين دعم قاعدة البيانات.',
